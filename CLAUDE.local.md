...
- **`9.29__bms_pos_pharmacist_counter_authorization.sql` (เภสัชกรกด PIN อนุมัติจ่ายยาที่เครื่องขาย —
  ...
  · **ยังไม่ได้ทำ (จงใจ)**: คิวออนไลน์ยังเลือกยาที่ต้องมีใบสั่งเข้า draft ไม่ได้ (ตรวจใบสั่งผ่านแชทไม่ได้)
    · การคืนยาเข้าสต็อกยังไม่มีด่านของร้านยา · ไม่มีการบังคับว่าต้องมีเภสัชกรอยู่เวรสำหรับยาสามัญ
      (ประทับว่าใครอยู่ ไม่ได้บังคับ)
