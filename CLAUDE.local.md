...
`npm run gate` ผ่าน (typecheck · **pure 923** · production build) · **ไม่มี permission ใหม่** ·
...
- ใหม่ 2 ไฟล์: `scripts/admin-sidebar-footer-contract.test.mts` (**9 เทส**) +
  `scripts/new-account-defaults-contract.test.mts` (**4 เทส**) · ทั้งคู่ pure
- **ผ่าน mutation test 15 แบบ แดงถูกตัวทุกครั้ง** (ท้ายแถบ 10 · ค่าปริยาย 5) — รวมเคส
