...
- **ปักคำตอบของคำถามทั้ง 51 ข้อ + ย้าย FAQ จาก Manual เข้าแคตตาล็อก (2026-08-28, ไม่มี migration,
  ...
  · **ยังไม่ได้ทำ (จงใจ)**: ไม่ได้บังคับว่าไกด์ทั้ง 90 ตัวต้องมีคำถามปักไว้ (ปักเฉพาะที่ UI ยื่นให้จริง +
    ที่เคยทดสอบ) · POS ยังไม่มี FAQ ของตัวเอง · citation ยังมาจากการค้นคำถามเหมือนเดิม
