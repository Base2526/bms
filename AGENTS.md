...
`7.52__bms_generated_reports.sql`) are also shared across three entry points: staff AI tool
...
- **Job run history** (`apps/web/lib/bms/jobRuns.ts`, migration `7.53`) — see `docs/architecture/api.md`'s
