...
\restrict FzPJY2l8IL1Cva1p2Xuge7ybOObUhva60sPRF1yhOw87yE5MlUf15RUERmRCYG1
...
--
-- Name: bms_audit_log; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_audit_log (
    id bigint NOT NULL,
...
--
-- Name: bms_audit_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_audit_log_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_audit_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_audit_log_id_seq OWNED BY public.bms_audit_log.id;


--
-- Name: bms_channel_health_log; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_channel_health_log (
    id bigint NOT NULL,
    tenant_id uuid NOT NULL,
...
ALTER TABLE ONLY public.bms_channel_health_log FORCE ROW LEVEL SECURITY;


--
-- Name: bms_channel_health_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_channel_health_log_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_channel_health_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_channel_health_log_id_seq OWNED BY public.bms_channel_health_log.id;


--
-- Name: bms_conversation_helpers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_conversation_helpers (
    tenant_id uuid NOT NULL,
...
ALTER TABLE ONLY public.bms_conversation_helpers FORCE ROW LEVEL SECURITY;


--
-- Name: bms_conversation_notes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_conversation_notes (
    id bigint NOT NULL,
    tenant_id uuid NOT NULL,
    conversation_id uuid NOT NULL,
    author text,
...
ALTER TABLE ONLY public.bms_conversation_notes FORCE ROW LEVEL SECURITY;


--
-- Name: bms_conversation_notes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_conversation_notes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_conversation_notes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_conversation_notes_id_seq OWNED BY public.bms_conversation_notes.id;


--
-- Name: bms_conversations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_conversations (
    ...
    CONSTRAINT bms_conversations_status_check CHECK ((status = ANY (ARRAY['OPEN'::text, 'PENDING'::text, 'CLOSED'::text]))),
    CONSTRAINT bms_conversations_unread_check CHECK ((unread >= 0))
);

ALTER TABLE ONLY public.bms_conversations FORCE ROW LEVEL SECURITY;


--
-- Name: bms_customer_addresses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_customer_addresses (
    id bigint NOT NULL,
    ...
    CONSTRAINT bms_customer_addresses_address_type_check CHECK ((address_type = ANY (ARRAY['shipping'::text, 'billing'::text])))
);

ALTER TABLE ONLY public.bms_customer_addresses FORCE ROW LEVEL SECURITY;


--
-- Name: bms_customer_addresses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_customer_addresses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_customer_addresses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_customer_addresses_id_seq OWNED BY public.bms_customer_addresses.id;


--
-- Name: bms_customer_ai_summary; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_customer_ai_summary (
    tenant_id uuid NOT NULL,
    customer_id uuid NOT NULL,
...
ALTER TABLE ONLY public.bms_customer_ai_summary FORCE ROW LEVEL SECURITY;


--
-- Name: bms_customer_identities; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_customer_identities (
    id bigint NOT NULL,
    customer_id uuid NOT NULL,
    channel text NOT NULL,
...
ALTER TABLE ONLY public.bms_customer_identities FORCE ROW LEVEL SECURITY;


--
-- Name: bms_customer_identities_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_customer_identities_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_customer_identities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_customer_identities_id_seq OWNED BY public.bms_customer_identities.id;


--
-- Name: bms_customers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_customers (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name text NOT NULL,
    phone text,
    note text,
...
ALTER TABLE ONLY public.bms_customers FORCE ROW LEVEL SECURITY;
...
CREATE TABLE public.bms_inventory (
    ...
    tenant_id uuid NOT NULL,
    CONSTRAINT bms_inventory_check CHECK ((reserved_stock <= current_stock)),
    CONSTRAINT bms_inventory_current_stock_check CHECK ((current_stock >= 0)),
    CONSTRAINT bms_inventory_reorder_point_check CHECK ((reorder_point >= 0)),
    CONSTRAINT bms_inventory_reserved_stock_check CHECK ((reserved_stock >= 0))
);

ALTER TABLE ONLY public.bms_inventory FORCE ROW LEVEL SECURITY;


--
-- Name: bms_messages; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_messages (
    id bigint NOT NULL,
    tenant_id uuid NOT NULL,
    conversation_id uuid NOT NULL,
    ...
    meta jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT bms_messages_direction_check CHECK ((direction = ANY (ARRAY['IN'::text, 'OUT'::text])))
);

ALTER TABLE ONLY public.bms_messages FORCE ROW LEVEL SECURITY;


--
-- Name: bms_messages_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_messages_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_messages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_messages_id_seq OWNED BY public.bms_messages.id;


--
-- Name: bms_order_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_order_items (
    id bigint NOT NULL,
    ...
    tenant_id uuid NOT NULL,
    CONSTRAINT bms_order_items_qty_check CHECK ((qty > 0)),
    CONSTRAINT bms_order_items_unit_price_check CHECK ((unit_price >= (0)::numeric))
);

ALTER TABLE ONLY public.bms_order_items FORCE ROW LEVEL SECURITY;


--
-- Name: bms_order_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_order_items_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_order_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_order_items_id_seq OWNED BY public.bms_order_items.id;


--
-- Name: bms_orders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_orders (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    channel text NOT NULL,
    customer_ref text,
    ...
    customer_id uuid,
    tenant_id uuid NOT NULL,
    CONSTRAINT bms_orders_status_check CHECK ((status = ANY (ARRAY['PENDING'::text, 'PAID'::text, 'PACKING'::text, 'SHIPPED'::text, 'COMPLETED'::text, 'CANCELLED'::text, 'RETURNED'::text]))),
    CONSTRAINT bms_orders_total_amount_check CHECK ((total_amount >= (0)::numeric))
);

ALTER TABLE ONLY public.bms_orders FORCE ROW LEVEL SECURITY;


--
-- Name: bms_payments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_payments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    order_id uuid NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT bms_payments_amount_check CHECK ((amount >= (0)::numeric)),
    CONSTRAINT bms_payments_method_check CHECK ((method = ANY (ARRAY['BANK_TRANSFER'::text, 'QR'::text, 'CARD'::text, 'TIKTOK'::text, 'CASH'::text]))),
    CONSTRAINT bms_payments_status_check CHECK ((status = ANY (ARRAY['PENDING'::text, 'CONFIRMED'::text, 'REJECTED'::text, 'REFUNDED'::text])))
);

ALTER TABLE ONLY public.bms_payments FORCE ROW LEVEL SECURITY;


--
-- Name: bms_plans; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_plans (
    code text NOT NULL,
    name text NOT NULL,
    price_monthly numeric(10,2) DEFAULT 0 NOT NULL,
    max_products integer DEFAULT '-1'::integer NOT NULL,
    max_channels integer DEFAULT '-1'::integer NOT NULL,
    max_orders_month integer DEFAULT '-1'::integer NOT NULL,
...
--
-- Name: bms_product_categories; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_product_categories (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE ONLY public.bms_product_categories FORCE ROW LEVEL SECURITY;


--
-- Name: bms_products; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_products (
    sku text NOT NULL,
    name text NOT NULL,
    ...
    category text,
    brand text,
    CONSTRAINT bms_products_price_check CHECK ((price >= (0)::numeric))
);

ALTER TABLE ONLY public.bms_products FORCE ROW LEVEL SECURITY;


--
-- Name: bms_purchase_order_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_purchase_order_items (
    id bigint NOT NULL,
    tenant_id uuid NOT NULL,
    po_id uuid NOT NULL,
    product_sku text NOT NULL,
    ...
    CONSTRAINT bms_purchase_order_items_check CHECK ((qty_received <= qty_ordered)),
    CONSTRAINT bms_purchase_order_items_qty_ordered_check CHECK ((qty_ordered > 0)),
    CONSTRAINT bms_purchase_order_items_qty_received_check CHECK ((qty_received >= 0)),
    CONSTRAINT bms_purchase_order_items_unit_cost_check CHECK ((unit_cost >= (0)::numeric))
);

ALTER TABLE ONLY public.bms_purchase_order_items FORCE ROW LEVEL SECURITY;


--
-- Name: bms_purchase_order_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_purchase_order_items_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_purchase_order_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_purchase_order_items_id_seq OWNED BY public.bms_purchase_order_items.id;


--
-- Name: bms_purchase_orders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_purchase_orders (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    supplier_id uuid,
    status text DEFAULT 'OPEN'::text NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT bms_purchase_orders_status_check CHECK ((status = ANY (ARRAY['OPEN'::text, 'PARTIAL'::text, 'RECEIVED'::text, 'CANCELLED'::text]))),
    CONSTRAINT bms_purchase_orders_total_amount_check CHECK ((total_amount >= (0)::numeric))
);

ALTER TABLE ONLY public.bms_purchase_orders FORCE ROW LEVEL SECURITY;


--
-- Name: bms_role_permissions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_role_permissions (
...
--
-- Name: bms_shipments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_shipments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    order_id uuid NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT bms_shipments_carrier_check CHECK ((carrier = ANY (ARRAY['FLASH'::text, 'KERRY'::text, 'DHL'::text, 'AUSPOST'::text, 'NZPOST'::text, 'OTHER'::text]))),
    CONSTRAINT bms_shipments_status_check CHECK ((status = ANY (ARRAY['PENDING'::text, 'SHIPPED'::text, 'IN_TRANSIT'::text, 'DELIVERED'::text, 'RETURNED'::text, 'CANCELLED'::text])))
);

ALTER TABLE ONLY public.bms_shipments FORCE ROW LEVEL SECURITY;


--
-- Name: bms_stock_movements; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_stock_movements (
    id bigint NOT NULL,
    product_sku text NOT NULL,
    size text NOT NULL,
    type text NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    tenant_id uuid NOT NULL,
    CONSTRAINT bms_stock_movements_qty_check CHECK ((qty > 0)),
    CONSTRAINT bms_stock_movements_type_check CHECK ((type = ANY (ARRAY['STOCK_IN'::text, 'STOCK_OUT'::text, 'RESERVE'::text, 'RELEASE'::text, 'SHIP'::text, 'RETURN'::text])))
);

ALTER TABLE ONLY public.bms_stock_movements FORCE ROW LEVEL SECURITY;


--
-- Name: bms_stock_movements_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_stock_movements_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_stock_movements_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_stock_movements_id_seq OWNED BY public.bms_stock_movements.id;


--
-- Name: bms_suppliers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_suppliers (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    name text NOT NULL,
    phone text,
...
ALTER TABLE ONLY public.bms_suppliers FORCE ROW LEVEL SECURITY;


--
-- Name: bms_tenant_channels; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_tenant_channels (
    id bigint NOT NULL,
    tenant_id uuid NOT NULL,
    channel text NOT NULL,
    access_token text,
    ...
    CONSTRAINT bms_tenant_channels_status_check CHECK ((status = ANY (ARRAY['connected'::text, 'token_expired'::text, 'webhook_failed'::text, 'rate_limited'::text, 'no_events'::text, 'send_failed'::text])))
);


--
-- Name: bms_tenant_channels_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bms_tenant_channels_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bms_tenant_channels_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bms_tenant_channels_id_seq OWNED BY public.bms_tenant_channels.id;


--
-- Name: bms_tenants; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bms_tenants (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name text NOT NULL,
    slug text NOT NULL,
...
--
-- Name: bms_audit_log id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_audit_log ALTER COLUMN id SET DEFAULT nextval('public.bms_audit_log_id_seq'::regclass);


--
-- Name: bms_channel_health_log id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_channel_health_log ALTER COLUMN id SET DEFAULT nextval('public.bms_channel_health_log_id_seq'::regclass);


--
-- Name: bms_conversation_notes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_notes ALTER COLUMN id SET DEFAULT nextval('public.bms_conversation_notes_id_seq'::regclass);


--
-- Name: bms_customer_addresses id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_addresses ALTER COLUMN id SET DEFAULT nextval('public.bms_customer_addresses_id_seq'::regclass);


--
-- Name: bms_customer_identities id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_identities ALTER COLUMN id SET DEFAULT nextval('public.bms_customer_identities_id_seq'::regclass);


--
-- Name: bms_messages id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_messages ALTER COLUMN id SET DEFAULT nextval('public.bms_messages_id_seq'::regclass);


--
-- Name: bms_order_items id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_order_items ALTER COLUMN id SET DEFAULT nextval('public.bms_order_items_id_seq'::regclass);


--
-- Name: bms_purchase_order_items id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_order_items ALTER COLUMN id SET DEFAULT nextval('public.bms_purchase_order_items_id_seq'::regclass);


--
-- Name: bms_stock_movements id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_stock_movements ALTER COLUMN id SET DEFAULT nextval('public.bms_stock_movements_id_seq'::regclass);


--
-- Name: bms_tenant_channels id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_tenant_channels ALTER COLUMN id SET DEFAULT nextval('public.bms_tenant_channels_id_seq'::regclass);
...
--
-- Name: bms_audit_log bms_audit_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_audit_log
    ADD CONSTRAINT bms_audit_log_pkey PRIMARY KEY (id);


--
-- Name: bms_channel_health_log bms_channel_health_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_channel_health_log
    ADD CONSTRAINT bms_channel_health_log_pkey PRIMARY KEY (id);


--
-- Name: bms_conversation_helpers bms_conversation_helpers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_helpers
    ADD CONSTRAINT bms_conversation_helpers_pkey PRIMARY KEY (conversation_id, user_id);


--
-- Name: bms_conversation_notes bms_conversation_notes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_notes
    ADD CONSTRAINT bms_conversation_notes_pkey PRIMARY KEY (id);


--
-- Name: bms_conversations bms_conversations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversations
    ADD CONSTRAINT bms_conversations_pkey PRIMARY KEY (id);


--
-- Name: bms_conversations bms_conversations_tenant_id_channel_customer_ref_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversations
    ADD CONSTRAINT bms_conversations_tenant_id_channel_customer_ref_key UNIQUE (tenant_id, channel, customer_ref);


--
-- Name: bms_customer_identities bms_cust_identities_uq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_identities
    ADD CONSTRAINT bms_cust_identities_uq UNIQUE (tenant_id, channel, external_ref);


--
-- Name: bms_customer_addresses bms_customer_addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_addresses
    ADD CONSTRAINT bms_customer_addresses_pkey PRIMARY KEY (id);


--
-- Name: bms_customer_ai_summary bms_customer_ai_summary_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_ai_summary
    ADD CONSTRAINT bms_customer_ai_summary_pkey PRIMARY KEY (customer_id);


--
-- Name: bms_customer_identities bms_customer_identities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_identities
    ADD CONSTRAINT bms_customer_identities_pkey PRIMARY KEY (id);


--
-- Name: bms_customers bms_customers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customers
    ADD CONSTRAINT bms_customers_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.bms_inventory
    ADD CONSTRAINT bms_inventory_pkey PRIMARY KEY (tenant_id, product_sku, size);


--
-- Name: bms_messages bms_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_messages
    ADD CONSTRAINT bms_messages_pkey PRIMARY KEY (id);


--
-- Name: bms_order_items bms_order_items_order_id_product_sku_size_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_order_items
    ADD CONSTRAINT bms_order_items_order_id_product_sku_size_key UNIQUE (order_id, product_sku, size);


--
-- Name: bms_order_items bms_order_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_order_items
    ADD CONSTRAINT bms_order_items_pkey PRIMARY KEY (id);


--
-- Name: bms_orders bms_orders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_orders
    ADD CONSTRAINT bms_orders_pkey PRIMARY KEY (id);


--
-- Name: bms_payments bms_payments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_payments
    ADD CONSTRAINT bms_payments_pkey PRIMARY KEY (id);


--
-- Name: bms_plans bms_plans_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_plans
    ADD CONSTRAINT bms_plans_pkey PRIMARY KEY (code);


--
-- Name: bms_product_categories bms_product_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_product_categories
    ADD CONSTRAINT bms_product_categories_pkey PRIMARY KEY (id);


--
-- Name: bms_product_categories bms_product_categories_tenant_id_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_product_categories
    ADD CONSTRAINT bms_product_categories_tenant_id_name_key UNIQUE (tenant_id, name);


--
-- Name: bms_products bms_products_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_products
    ADD CONSTRAINT bms_products_pkey PRIMARY KEY (tenant_id, sku);


--
-- Name: bms_purchase_order_items bms_purchase_order_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_order_items
    ADD CONSTRAINT bms_purchase_order_items_pkey PRIMARY KEY (id);


--
-- Name: bms_purchase_order_items bms_purchase_order_items_po_id_product_sku_size_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_order_items
    ADD CONSTRAINT bms_purchase_order_items_po_id_product_sku_size_key UNIQUE (po_id, product_sku, size);


--
-- Name: bms_purchase_orders bms_purchase_orders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_orders
    ADD CONSTRAINT bms_purchase_orders_pkey PRIMARY KEY (id);


--
-- Name: bms_role_permissions bms_role_permissions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_role_permissions
    ADD CONSTRAINT bms_role_permissions_pkey PRIMARY KEY (tenant_id, role_id, permission);


--
-- Name: bms_shipments bms_shipments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_shipments
    ADD CONSTRAINT bms_shipments_pkey PRIMARY KEY (id);


--
-- Name: bms_stock_movements bms_stock_movements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_stock_movements
    ADD CONSTRAINT bms_stock_movements_pkey PRIMARY KEY (id);


--
-- Name: bms_suppliers bms_suppliers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_suppliers
    ADD CONSTRAINT bms_suppliers_pkey PRIMARY KEY (id);


--
-- Name: bms_suppliers bms_suppliers_tenant_id_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_suppliers
    ADD CONSTRAINT bms_suppliers_tenant_id_name_key UNIQUE (tenant_id, name);


--
-- Name: bms_tenant_channels bms_tenant_channels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_tenant_channels
    ADD CONSTRAINT bms_tenant_channels_pkey PRIMARY KEY (id);


--
-- Name: bms_tenant_channels bms_tenant_channels_tenant_id_channel_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_tenant_channels
    ADD CONSTRAINT bms_tenant_channels_tenant_id_channel_key UNIQUE (tenant_id, channel);


--
-- Name: bms_tenants bms_tenants_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_tenants
    ADD CONSTRAINT bms_tenants_pkey PRIMARY KEY (id);


--
-- Name: bms_tenants bms_tenants_slug_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_tenants
    ADD CONSTRAINT bms_tenants_slug_key UNIQUE (slug);
...
--
-- Name: idx_bms_audit_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_audit_tenant ON public.bms_audit_log USING btree (tenant_id, created_at DESC);


--
-- Name: idx_bms_channel_health_log_tenant_channel; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_channel_health_log_tenant_channel ON public.bms_channel_health_log USING btree (tenant_id, channel, occurred_at DESC);


--
-- Name: idx_bms_conv_assigned; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_assigned ON public.bms_conversations USING btree (tenant_id, assigned_to);


--
-- Name: idx_bms_conv_assigned_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_assigned_user ON public.bms_conversations USING btree (tenant_id, assigned_to_user_id);


--
-- Name: idx_bms_conv_customer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_customer ON public.bms_conversations USING btree (customer_id);


--
-- Name: idx_bms_conv_helpers_conv; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_helpers_conv ON public.bms_conversation_helpers USING btree (conversation_id);


--
-- Name: idx_bms_conv_helpers_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_helpers_user ON public.bms_conversation_helpers USING btree (tenant_id, user_id);


--
-- Name: idx_bms_conv_notes; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_notes ON public.bms_conversation_notes USING btree (conversation_id, created_at DESC);


--
-- Name: idx_bms_conv_tags; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_tags ON public.bms_conversations USING gin (tags);


--
-- Name: idx_bms_conv_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_conv_tenant ON public.bms_conversations USING btree (tenant_id, status, last_message_at DESC);


--
-- Name: idx_bms_cust_addr_customer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_cust_addr_customer ON public.bms_customer_addresses USING btree (customer_id);


--
-- Name: idx_bms_cust_ai_summary_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_cust_ai_summary_tenant ON public.bms_customer_ai_summary USING btree (tenant_id);


--
-- Name: idx_bms_cust_identities_customer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_cust_identities_customer ON public.bms_customer_identities USING btree (customer_id);


--
-- Name: idx_bms_customers_phone; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_customers_phone ON public.bms_customers USING btree (phone) WHERE (phone IS NOT NULL);


--
-- Name: idx_bms_customers_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_customers_tenant ON public.bms_customers USING btree (tenant_id) WHERE (deleted_at IS NULL);


--
-- Name: idx_bms_messages_conv; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_messages_conv ON public.bms_messages USING btree (conversation_id, created_at);


--
-- Name: idx_bms_movements_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_movements_order ON public.bms_stock_movements USING btree (ref_order_id);


--
-- Name: idx_bms_movements_sku_size; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_movements_sku_size ON public.bms_stock_movements USING btree (product_sku, size, created_at DESC);


--
-- Name: idx_bms_movements_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_movements_tenant ON public.bms_stock_movements USING btree (tenant_id, product_sku);


--
-- Name: idx_bms_order_items_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_order_items_order ON public.bms_order_items USING btree (order_id);


--
-- Name: idx_bms_orders_customer; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_orders_customer ON public.bms_orders USING btree (customer_ref);


--
-- Name: idx_bms_orders_customer_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_orders_customer_id ON public.bms_orders USING btree (customer_id);


--
-- Name: idx_bms_orders_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_orders_tenant ON public.bms_orders USING btree (tenant_id, status);


--
-- Name: idx_bms_payments_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_payments_order ON public.bms_payments USING btree (order_id);


--
-- Name: idx_bms_payments_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_payments_tenant ON public.bms_payments USING btree (tenant_id, status);


--
-- Name: idx_bms_po_items_po; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_po_items_po ON public.bms_purchase_order_items USING btree (po_id);


--
-- Name: idx_bms_po_supplier; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_po_supplier ON public.bms_purchase_orders USING btree (supplier_id);


--
-- Name: idx_bms_po_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_po_tenant ON public.bms_purchase_orders USING btree (tenant_id, status);


--
-- Name: idx_bms_product_categories_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_product_categories_tenant ON public.bms_product_categories USING btree (tenant_id);


--
-- Name: idx_bms_products_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_products_category ON public.bms_products USING btree (tenant_id, category) WHERE (category IS NOT NULL);


--
-- Name: idx_bms_products_keywords; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_products_keywords ON public.bms_products USING gin (keywords);


--
-- Name: idx_bms_products_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_products_tenant ON public.bms_products USING btree (tenant_id);


--
-- Name: idx_bms_role_perms_role; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_role_perms_role ON public.bms_role_permissions USING btree (role_id);


--
-- Name: idx_bms_shipments_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_shipments_order ON public.bms_shipments USING btree (order_id);


--
-- Name: idx_bms_shipments_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_shipments_tenant ON public.bms_shipments USING btree (tenant_id, status);


--
-- Name: idx_bms_shipments_tracking; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_shipments_tracking ON public.bms_shipments USING btree (tracking_no) WHERE (tracking_no IS NOT NULL);


--
-- Name: idx_bms_suppliers_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bms_suppliers_tenant ON public.bms_suppliers USING btree (tenant_id);
...
CREATE INDEX idx_users_platform_admin ON public.users USING btree (is_platform_admin) WHERE is_platform_admin;
...
--
-- Name: uq_bms_products_barcode; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_bms_products_barcode ON public.bms_products USING btree (barcode) WHERE (barcode IS NOT NULL);
...
--
-- Name: bms_audit_log bms_audit_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_audit_log
    ADD CONSTRAINT bms_audit_log_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_channel_health_log bms_channel_health_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_channel_health_log
    ADD CONSTRAINT bms_channel_health_log_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_conversation_helpers bms_conversation_helpers_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_helpers
    ADD CONSTRAINT bms_conversation_helpers_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.bms_conversations(id) ON DELETE CASCADE;


--
-- Name: bms_conversation_helpers bms_conversation_helpers_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_helpers
    ADD CONSTRAINT bms_conversation_helpers_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_conversation_helpers bms_conversation_helpers_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_helpers
    ADD CONSTRAINT bms_conversation_helpers_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: bms_conversation_notes bms_conversation_notes_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_notes
    ADD CONSTRAINT bms_conversation_notes_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.bms_conversations(id) ON DELETE CASCADE;


--
-- Name: bms_conversation_notes bms_conversation_notes_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversation_notes
    ADD CONSTRAINT bms_conversation_notes_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_conversations bms_conversations_assigned_to_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversations
    ADD CONSTRAINT bms_conversations_assigned_to_user_id_fkey FOREIGN KEY (assigned_to_user_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: bms_conversations bms_conversations_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversations
    ADD CONSTRAINT bms_conversations_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.bms_customers(id) ON DELETE SET NULL;


--
-- Name: bms_conversations bms_conversations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_conversations
    ADD CONSTRAINT bms_conversations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_customer_addresses bms_customer_addresses_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_addresses
    ADD CONSTRAINT bms_customer_addresses_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.bms_customers(id) ON DELETE CASCADE;


--
-- Name: bms_customer_addresses bms_customer_addresses_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_addresses
    ADD CONSTRAINT bms_customer_addresses_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_customer_ai_summary bms_customer_ai_summary_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_ai_summary
    ADD CONSTRAINT bms_customer_ai_summary_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.bms_customers(id) ON DELETE CASCADE;


--
-- Name: bms_customer_ai_summary bms_customer_ai_summary_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_ai_summary
    ADD CONSTRAINT bms_customer_ai_summary_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_customer_identities bms_customer_identities_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_identities
    ADD CONSTRAINT bms_customer_identities_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.bms_customers(id) ON DELETE CASCADE;


--
-- Name: bms_customer_identities bms_customer_identities_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customer_identities
    ADD CONSTRAINT bms_customer_identities_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_customers bms_customers_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_customers
    ADD CONSTRAINT bms_customers_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_inventory bms_inventory_product_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_inventory
    ADD CONSTRAINT bms_inventory_product_fk FOREIGN KEY (tenant_id, product_sku) REFERENCES public.bms_products(tenant_id, sku) ON DELETE CASCADE;


--
-- Name: bms_inventory bms_inventory_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_inventory
    ADD CONSTRAINT bms_inventory_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_messages bms_messages_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_messages
    ADD CONSTRAINT bms_messages_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.bms_conversations(id) ON DELETE CASCADE;


--
-- Name: bms_messages bms_messages_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_messages
    ADD CONSTRAINT bms_messages_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_order_items bms_order_items_inv_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_order_items
    ADD CONSTRAINT bms_order_items_inv_fk FOREIGN KEY (tenant_id, product_sku, size) REFERENCES public.bms_inventory(tenant_id, product_sku, size);


--
-- Name: bms_order_items bms_order_items_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_order_items
    ADD CONSTRAINT bms_order_items_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.bms_orders(id) ON DELETE CASCADE;


--
-- Name: bms_order_items bms_order_items_product_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_order_items
    ADD CONSTRAINT bms_order_items_product_fk FOREIGN KEY (tenant_id, product_sku) REFERENCES public.bms_products(tenant_id, sku);


--
-- Name: bms_order_items bms_order_items_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_order_items
    ADD CONSTRAINT bms_order_items_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_orders bms_orders_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_orders
    ADD CONSTRAINT bms_orders_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.bms_customers(id);


--
-- Name: bms_orders bms_orders_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_orders
    ADD CONSTRAINT bms_orders_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_payments bms_payments_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_payments
    ADD CONSTRAINT bms_payments_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.bms_orders(id) ON DELETE CASCADE;


--
-- Name: bms_payments bms_payments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_payments
    ADD CONSTRAINT bms_payments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_product_categories bms_product_categories_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_product_categories
    ADD CONSTRAINT bms_product_categories_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_products bms_products_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_products
    ADD CONSTRAINT bms_products_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_purchase_order_items bms_purchase_order_items_po_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_order_items
    ADD CONSTRAINT bms_purchase_order_items_po_id_fkey FOREIGN KEY (po_id) REFERENCES public.bms_purchase_orders(id) ON DELETE CASCADE;


--
-- Name: bms_purchase_order_items bms_purchase_order_items_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_order_items
    ADD CONSTRAINT bms_purchase_order_items_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_purchase_order_items bms_purchase_order_items_tenant_id_product_sku_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_order_items
    ADD CONSTRAINT bms_purchase_order_items_tenant_id_product_sku_fkey FOREIGN KEY (tenant_id, product_sku) REFERENCES public.bms_products(tenant_id, sku);


--
-- Name: bms_purchase_orders bms_purchase_orders_supplier_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_orders
    ADD CONSTRAINT bms_purchase_orders_supplier_id_fkey FOREIGN KEY (supplier_id) REFERENCES public.bms_suppliers(id) ON DELETE SET NULL;


--
-- Name: bms_purchase_orders bms_purchase_orders_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_purchase_orders
    ADD CONSTRAINT bms_purchase_orders_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_role_permissions bms_role_permissions_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_role_permissions
    ADD CONSTRAINT bms_role_permissions_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(id) ON DELETE CASCADE;


--
-- Name: bms_role_permissions bms_role_perms_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_role_permissions
    ADD CONSTRAINT bms_role_perms_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_shipments bms_shipments_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_shipments
    ADD CONSTRAINT bms_shipments_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.bms_orders(id) ON DELETE CASCADE;


--
-- Name: bms_shipments bms_shipments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_shipments
    ADD CONSTRAINT bms_shipments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_stock_movements bms_stock_movements_product_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_stock_movements
    ADD CONSTRAINT bms_stock_movements_product_fk FOREIGN KEY (tenant_id, product_sku) REFERENCES public.bms_products(tenant_id, sku);


--
-- Name: bms_stock_movements bms_stock_movements_ref_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_stock_movements
    ADD CONSTRAINT bms_stock_movements_ref_order_id_fkey FOREIGN KEY (ref_order_id) REFERENCES public.bms_orders(id) ON DELETE SET NULL;


--
-- Name: bms_stock_movements bms_stock_movements_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_stock_movements
    ADD CONSTRAINT bms_stock_movements_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);


--
-- Name: bms_suppliers bms_suppliers_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_suppliers
    ADD CONSTRAINT bms_suppliers_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;


--
-- Name: bms_tenant_channels bms_tenant_channels_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bms_tenant_channels
    ADD CONSTRAINT bms_tenant_channels_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id) ON DELETE CASCADE;
...
--
-- Name: users users_tenant_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_tenant_fk FOREIGN KEY (tenant_id) REFERENCES public.bms_tenants(id);
...
--
-- Name: bms_channel_health_log; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_channel_health_log ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_channel_health_log bms_channel_health_log_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_channel_health_log_tenant_isolation ON public.bms_channel_health_log USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_conversation_helpers; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_conversation_helpers ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_conversation_helpers bms_conversation_helpers_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_conversation_helpers_tenant_isolation ON public.bms_conversation_helpers USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_conversation_notes; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_conversation_notes ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_conversation_notes bms_conversation_notes_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_conversation_notes_tenant_isolation ON public.bms_conversation_notes USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_conversations; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_conversations ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_conversations bms_conversations_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_conversations_tenant_isolation ON public.bms_conversations USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_customer_addresses; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_customer_addresses ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_customer_addresses bms_customer_addresses_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_customer_addresses_tenant_isolation ON public.bms_customer_addresses USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_customer_ai_summary; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_customer_ai_summary ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_customer_ai_summary bms_customer_ai_summary_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_customer_ai_summary_tenant_isolation ON public.bms_customer_ai_summary USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_customer_identities; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_customer_identities ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_customer_identities bms_customer_identities_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_customer_identities_tenant_isolation ON public.bms_customer_identities USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_customers; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_customers ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_customers bms_customers_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_customers_tenant_isolation ON public.bms_customers USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_inventory; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_inventory ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_inventory bms_inventory_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_inventory_tenant_isolation ON public.bms_inventory USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_messages; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_messages ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_messages bms_messages_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_messages_tenant_isolation ON public.bms_messages USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_order_items; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_order_items ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_order_items bms_order_items_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_order_items_tenant_isolation ON public.bms_order_items USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_orders; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_orders ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_orders bms_orders_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_orders_tenant_isolation ON public.bms_orders USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_payments; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_payments ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_payments bms_payments_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_payments_tenant_isolation ON public.bms_payments USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_product_categories; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_product_categories ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_product_categories bms_product_categories_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_product_categories_tenant_isolation ON public.bms_product_categories USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_products; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_products ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_products bms_products_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_products_tenant_isolation ON public.bms_products USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_purchase_order_items; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_purchase_order_items ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_purchase_order_items bms_purchase_order_items_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_purchase_order_items_tenant_isolation ON public.bms_purchase_order_items USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_purchase_orders; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_purchase_orders ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_purchase_orders bms_purchase_orders_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_purchase_orders_tenant_isolation ON public.bms_purchase_orders USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_shipments; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_shipments ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_shipments bms_shipments_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_shipments_tenant_isolation ON public.bms_shipments USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_stock_movements; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_stock_movements ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_stock_movements bms_stock_movements_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_stock_movements_tenant_isolation ON public.bms_stock_movements USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));


--
-- Name: bms_suppliers; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.bms_suppliers ENABLE ROW LEVEL SECURITY;

--
-- Name: bms_suppliers bms_suppliers_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY bms_suppliers_tenant_isolation ON public.bms_suppliers USING ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id))) WITH CHECK ((tenant_id = COALESCE((NULLIF(current_setting('bms.tenant_id'::text, true), ''::text))::uuid, tenant_id)));
...
\unrestrict FzPJY2l8IL1Cva1p2Xuge7ybOObUhva60sPRF1yhOw87yE5MlUf15RUERmRCYG1
