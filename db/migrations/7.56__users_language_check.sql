-- =============================================================
-- 7.56  users.language — CHECK constraint (defense in depth)
-- (renumbered from 7.55 while merging `multi-language` into `develop`: 7.55
-- collided with 7.55__bms_job_runs.sql, already merged into develop from
