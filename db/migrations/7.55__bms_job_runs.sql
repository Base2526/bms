-- =============================================================
-- 7.55  BMS Job Runs — execution history for cron/batch entrypoints
-- (renumbered from 7.53 while merging feat/redis-infra-improvements into
-- feat/report-generation: 7.53 collided with 7.53__bms_generated_reports.sql,
