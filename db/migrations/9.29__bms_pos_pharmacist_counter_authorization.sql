...
--     · ทางที่เปิดคือ **ที่เคาน์เตอร์เท่านั้น** (กด PIN ที่นี่ หรือเคสที่ยกมาจากเครื่องขาย)
--       ใบสั่งแพทย์เป็นกระดาษที่เภสัชกรรับไว้ในมือแล้วส่งยาข้ามเคาน์เตอร์ ไม่ใช่สิ่งที่
--       อนุมัติจากห้องแชทแล้วส่งของออกไป — ฝั่งออนไลน์ยังบล็อกเหมือนเดิม
...
CREATE TABLE IF NOT EXISTS bms_pos_pharmacist_authorizations (
  ...
  -- CASCADE ตามบิล: หลักฐานนี้เป็นเรื่องของบิลใบหนึ่ง ไม่มีบิลก็ไม่มีอะไรให้อ้าง ·
  -- บิลใน production ไม่เคยถูกลบจริง (ยกเลิก = เปลี่ยนสถานะ) แถวนี้จึงหายได้เฉพาะตอน
  -- ล้างข้อมูลทดสอบ ซึ่งเป็นพฤติกรรมที่ต้องการ · **ห้ามเปลี่ยนเป็น SET NULL** เพราะ
  -- หลักฐานที่ไม่รู้ว่าเป็นของบิลไหนตอบอะไรไม่ได้เลย
