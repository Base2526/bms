...
### 13. `board_game_cafe` — Board Game Cafe

**เหมาะกับ:** ร้านบอร์ดเกมคาเฟ่, board game bar, game library ที่คิดค่าเล่นตามเวลา

#### Onboarding Checklist
1. เพิ่มสินค้าเฉพาะของที่ขายจริง เช่น ขนม เครื่องดื่ม อุปกรณ์ และเกมที่ขายออกจากร้าน
2. ตั้งเรทราคาเวลาแยกจากสินค้า เช่น ทั่วไป/นักเรียน/สมาชิก ขั้นต่ำ การปัดเวลา และ grace period
3. วาง flow โต๊ะก่อนปิดบิลให้ครบ: คนในโต๊ะ จับเวลา แจ้งเตือน ต่อเวลา และแยกจ่าย
4. เก็บเกมที่ให้ลูกค้าเล่นเป็น asset มีรหัสกล่อง สภาพ และสถานะยืม/คืน ไม่ใช่ stock สินค้าปกติ
5. ถ้าต้องการให้ลูกค้าค้นหาร้านใกล้ฉัน ให้เปิด public discovery รายสาขา พร้อมพิกัด เวลาเปิด และข้อมูลที่ยอมเผยแพร่

#### AI Commerce Policy
| ด้าน | แนวทาง |
|------|--------|
| Sales motion | `time_session_visit` |
| Discovery | ตอบจากราคาเวลาเล่น กฎสมาชิก เกมที่ร้านเผยแพร่ public discovery และสินค้าจริงเท่านั้น |
| Basket | เสนอขนม/เครื่องดื่มหรือสินค้าเสริมจาก catalog ได้เมื่อเกี่ยวข้อง แต่ห้ามคำนวณค่าเวลาแทน backend |
| Repeat purchase | เน้นสมาชิก แพ็กเกจเวลา การจองโต๊ะ และการกลับมาเล่นซ้ำ |
| Fulfillment | อธิบายเวลาเปิด ราคาเบื้องต้น วิธีจอง/ติดต่อ และให้ POS/backend คำนวณค่าเล่นจริงตอนปิด session |

> **ขอบเขตสำคัญ:** `board_game_cafe` ไม่ได้ทำให้เกมที่ให้ยืมเป็น Product ปกติ และไม่เพิ่ม field ค่าเล่นลงในหน้า Products. สินค้าไว้ขายยังใช้ Product/Inventory เดิม ส่วนค่าเล่นต้องเป็น time rate และเกมไว้ให้เล่นต้องเป็น Game Library/Asset ใน module เฉพาะ. Public discovery เป็น opt-in ต่อสาขาและเผยแพร่เฉพาะข้อมูลร้าน/ราคา/เกมเด่น/จำนวนโต๊ะว่างแบบรวม ไม่เผยเลขโต๊ะ session ลูกค้า หรือข้อมูลสมาชิก.
...
| Board Game Cafe | ร้านบอร์ดเกมคาเฟ่ | `board_game_cafe` | general | — | time_session_visit |
