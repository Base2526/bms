...
Every one of the endpoints above (2026-08) records each invocation into `bms_job_runs`
(migration `7.53__bms_job_runs.sql`, `lib/bms/jobRuns.ts` `recordJobRun()`/`recordExternalJobRun()`)
