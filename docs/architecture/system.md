...
| Windows POS client | 🧪 MVP shell | `apps/desktop/` — Electron/NSIS shell for the existing authoritative `/pos` surface, with first-run server pairing, Windows DPAPI-backed token storage, origin-restricted IPC/navigation, and realtime token integration. Code signing, auto-update, direct ESC/POS/LAN printer and drawer support, offline tender, and production hardware verification remain — see [../../apps/desktop/README.md](../../apps/desktop/README.md) |
