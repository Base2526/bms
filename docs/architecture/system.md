...
| Shipping | ✅ | `lib/bms/shipping.ts` · `5.4__bms_shipments.sql` + `7.76__bms_shipment_carrier_sync.sql` · carrier create/sync seam for Flash/Kerry (mock-ready, live docs still pending) |
