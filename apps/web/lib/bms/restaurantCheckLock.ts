 ...
 *
 * **เศษที่เหลือ (ยอมรับไว้โดยรู้ตัว)**: การอ่านหา scope เป็นการอ่านแบบไม่ล็อก ถ้าการแยก/
 * รวมบิล **ย้ายตั๋วข้ามบิล** พอดีในช่องระหว่างอ่านกับล็อก ทรานแซกชันนี้จะถือบิลเก่าแล้วไปขอ
 * บิลใหม่ตามหลัง (ไม่ตรงลำดับ id) · ต้องบังเอิญพร้อมกันสามอย่างถึงจะวน — ย้ายตั๋วพอดี +
 * มีอีกคำขอที่ครอบสองบิลเดียวกัน + ลำดับ id ไม่เป็นใจ — และ Postgres ตรวจเจอแล้ว abort
 * สะอาด · เลือกไม่สร้างกลไกเพิ่ม เพราะแพงกว่าปัญหาที่มันกันได้
 *
