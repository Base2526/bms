...
const DEFINITIONS: OperationDefinition[] = [
  ...
  {
    key: "delivery-events-process",
    name: "Delivery Webhook Inbox",
    kind: "Cron Endpoint",
    sourcePath: "apps/web/app/api/bms/delivery/events/process/route.ts",
    docsPath: "docs/integrations/delivery-platforms.md",
    triggerHint: "POST /api/bms/delivery/events/process",
    purposeFallback: "Claim verified provider events, normalize them and create tenant-scoped orders atomically.",
    whenFallback: "Continuous worker recommended; 15-minute recovery schedule configured",
    statusFallback: "Scheduled",
    triggerFallback: "Continuous worker + GitHub Actions recovery schedule",
    evidenceFallback: "Called by the frequent matrix; the durable inbox remains safe across overlapping workers.",
  },
  {
    key: "delivery-commands-process",
    name: "Delivery Command Outbox",
    kind: "Cron Endpoint",
    sourcePath: "apps/web/app/api/bms/delivery/commands/process/route.ts",
    docsPath: "docs/integrations/delivery-platforms.md",
    triggerHint: "POST /api/bms/delivery/commands/process",
    purposeFallback: "Send committed delivery commands with bounded retries and explicit manual-action states.",
    whenFallback: "Continuous worker recommended; 15-minute recovery schedule configured",
    statusFallback: "Scheduled",
    triggerFallback: "Continuous worker + GitHub Actions recovery schedule",
    evidenceFallback: "Called by the frequent matrix; external API calls run after the business transaction commits.",
  },
  {
    key: "delivery-intake-auto-resume",
    name: "Delivery Timed Pause Resume",
    kind: "Cron Endpoint",
    sourcePath: "apps/web/app/api/bms/delivery/intake/auto-resume/route.ts",
    docsPath: "docs/integrations/delivery-platforms.md",
    triggerHint: "POST /api/bms/delivery/intake/auto-resume",
    purposeFallback: "Resume expired branch/provider pauses with compare-and-set protection and provider sync tracking.",
    whenFallback: "Every 15 minutes",
    statusFallback: "Scheduled",
    triggerFallback: "GitHub Actions frequent schedule",
    evidenceFallback: "Called by the frequent matrix in .github/workflows/bms-cron.yml.",
  ...
  {
    key: "delivery-scheduled-preparation",
    name: "Scheduled Delivery Preparation",
    kind: "Cron Endpoint",
    sourcePath: "apps/web/app/api/bms/delivery/scheduled-preparation/route.ts",
    docsPath: "docs/integrations/delivery-platforms.md",
    triggerHint: "POST /api/bms/delivery/scheduled-preparation",
    purposeFallback: "Create kitchen tickets only when an accepted scheduled provider order reaches its configured preparation time.",
    whenFallback: "Every 15 minutes (continuous worker recommended for tighter timing)",
    statusFallback: "Scheduled",
    triggerFallback: "GitHub Actions frequent schedule",
    evidenceFallback: "Called by the frequent matrix with a leased multi-instance-safe claim.",
  },
  {
    key: "delivery-acceptance-timeout",
    name: "Delivery Acceptance Timeout",
    kind: "Cron Endpoint",
    sourcePath: "apps/web/app/api/bms/delivery/acceptance-timeout/route.ts",
    docsPath: "docs/integrations/delivery-platforms.md",
    triggerHint: "POST /api/bms/delivery/acceptance-timeout",
    purposeFallback: "Block late acceptance and surface an audited manual-action incident without guessing provider reject/refund semantics.",
    whenFallback: "Every 15 minutes (continuous worker recommended for provider SLA timing)",
    statusFallback: "Scheduled",
    triggerFallback: "GitHub Actions frequent schedule",
    evidenceFallback: "Called by the frequent matrix with a leased multi-instance-safe claim.",
  },
  {
    key: "board-game-reservation-expiry",
    name: "Board-game Reservation Expiry",
    kind: "Cron Endpoint",
    sourcePath: "apps/web/app/api/bms/board-game/reservations/expire/route.ts",
    docsPath: "docs/business/board-game-cafe.md",
    triggerHint: "POST /api/bms/board-game/reservations/expire",
    purposeFallback: "Mark confirmed reservations as no-show after the six-hour arrival window.",
    whenFallback: "Every 15 minutes",
    statusFallback: "Scheduled",
    triggerFallback: "GitHub Actions frequent schedule",
    evidenceFallback: "Called by the frequent matrix in .github/workflows/bms-cron.yml.",
  ...
  {
    key: "board-game-pass-renewals",
    name: "Board-game Pass Renewals",
    kind: "Cron Endpoint",
    sourcePath: "apps/web/app/api/bms/board-game/pass-renewals/run/route.ts",
    docsPath: "docs/business/board-game-cafe.md",
    triggerHint: "POST /api/bms/board-game/pass-renewals/run",
    purposeFallback: "Renew due member passes atomically from customer-bound store credit.",
    whenFallback: "Every 15 minutes",
    statusFallback: "Scheduled",
    triggerFallback: "GitHub Actions frequent schedule",
    evidenceFallback: "Called by the frequent matrix in .github/workflows/bms-cron.yml.",
