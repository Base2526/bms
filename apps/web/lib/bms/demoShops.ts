...
export const DEMO_SHOPS: Record<DemoShopKey, DemoShopDefinition> = {
  fashion: {
    ...
    fallbackShopName: "Nami Fashion Demo",
  ...
  food: {
    ...
    fallbackShopName: "QuickBite Delivery Demo",
  ...
  beauty: {
    ...
    fallbackShopName: "Lumi Beauty Demo",
  ...
  grocery: {
    ...
    fallbackShopName: "Daily Mart Demo",
  ...
  gadgets: {
    ...
    fallbackShopName: "Spark Gadget Demo",
