...
const HUMAN_HANDOFF_PATTERN = /^(?:ขอ)?(?:คุย|พูด|ติดต่อ)(?:กับ)?เภสัชกร(?:หน่อย)?(?:ครับ|ค่ะ|คะ)?$/i;
const CORRECTION_PATTERN = /^(?:เมื่อกี้)?(?:ตอบผิด|ข้อมูลผิด|ขอแก้ไข|แก้ไขข้อมูล)(?:ครับ|ค่ะ|คะ)?$/i;
const CANCEL_PATTERN = /^(?:ไม่เอาแล้ว|ยกเลิก|หยุด|เริ่มใหม่|เปลี่ยนอาการ)(?:ครับ|ค่ะ|คะ)?$/i;
