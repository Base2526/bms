...
// จึงไม่ overwrite session ตรงๆ แต่ยังขัดกับ convention เดียวกับหน้า / (CLAUDE.md § Frontend
// conventions) ที่ให้ CTA/หน้า auth พาแอดมินที่ล็อกอินอยู่แล้วกลับเข้า operations แทน
