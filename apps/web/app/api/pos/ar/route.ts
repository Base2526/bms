...
// เกิดที่ /api/pos/ar/collect — ที่นี่ตอบแค่ "ปล่อยเชื่อได้อีกเท่าไร ค้างใบไหนอยู่บ้าง"
// ซึ่งเป็นสิ่งที่พนักงานต้องเห็นก่อนตัดสินใจ ไม่ใช่หลังจากบิลถูกปฏิเสธไปแล้ว
// =============================================================
