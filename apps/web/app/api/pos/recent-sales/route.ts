...
// ถ้ามีคำค้น route จะขยายไปค้นบิลปิดแล้วทุกช่องทางใน tenant เพื่อให้หน้าเคาน์เตอร์
// ไม่ตอบว่า "ไม่พบ" กับบิล web/social; marketplace ยังแสดงเพื่อชี้ทางแต่คืนที่นี่ไม่ได้
// =============================================================
