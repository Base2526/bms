...
import { DownloadOutlined, PrinterOutlined, ShopOutlined } from "@ant-design/icons";
import { useCallback, useState } from "react";
import { useBmsPermissions } from "@/app/hooks/useBmsPermissions";
import { useI18n } from "@/lib/i18nContext";
import styles from "./pos-manual.module.css";

const { Title, Paragraph, Text } = Typography;

type Tone = "slate" | "amber" | "blue" | "purple" | "red" | "green" | "dual";
...
// TH sections
// ---------------------------------------------------------------------------
const TH_SECTIONS: ManualSection[] = [
  {
    id: "access",
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: "p", text: "โหลดรายการเดิมที่เหลือเข้าตะกร้าใหม่ — เป็นการขายใหม่ ไม่ใช่การแก้ใบเสร็จเดิม" },
    ...
    blocks: [
      ...
      { kind: "sub", text: "ก่อนเปิดใช้งานจริง — รายการซ้อมที่ต้องผ่าน (ทุกข้อบนทุกเครื่องขาย)" },
      {
        ...
        items: [
          ...
          "ส่วนลดมือพร้อม PIN หัวหน้า · พักบิลแล้วเรียกคืนจากเครื่องที่สอง",
    ...
    blocks: [
      ...
      { kind: "sub", text: "Rehearsal checklist before going live (every item, on every register)" },
      {
        ...
        items: [
          ...
          "A manual discount with a supervisor PIN · parking a bill and recalling it from a second device",
...
function buildPosManualMarkdown(copy: PageCopy, sections: ManualSection[]): string {
  ...
  return (
    <div className={styles.page} data-print-root>
      <div className={styles.hero}>
        <Tag color="blue" style={{ width: "fit-content" }} icon={<ShopOutlined />}>{copy.heroTag}</Tag>
