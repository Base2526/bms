...
const Q = gql`
  query {
    bmsBilling {
      plan { code name price_monthly max_products max_channels max_orders_month }
      usage { products channels orders_month }
      plans { code name price_monthly max_products max_channels max_orders_month }
    }
  }
`;
