...
const ROUTES = {
  ...
  supportDiagnostics: "/admin/support-diagnostics",
  ...
  posShifts: "/admin/pos-shifts",
  posManual: "/admin/pos-manual",
  pharmacyManual: "/admin/pharmacy-manual",
  manual: "/admin/manual",
  posts: "/admin/posts",
} as const;
...
const MENU_CARDS_TH: MenuCard[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "ทำสำเนาสินค้าจะคัดลอก config สูตร Modifier แพ็ก และราคาเป็น Draft แต่ไม่คัดลอก stock, lot, serial หรือ barcode",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Store Capability เป็นค่าเปิดใช้ระดับร้าน ส่วน Product Stock Policy เป็นตัวกำหนดจริงรายสินค้า; การเปลี่ยนประเภทร้านไม่เปลี่ยน stock หรือสูตรย้อนหลัง",
      "Modifier ร้านอาหารจัดเป็นกลุ่มแบบเลือกหนึ่ง/หลายอย่าง พร้อมขั้นต่ำ สูงสุด และค่าเริ่มต้น; server ตรวจซ้ำตอนสร้างบิล",
      "ใน Recipe/Modifier ใช้ สร้างวัตถุดิบแบบเร็ว ได้ ระบบจะสร้าง Draft ภายในที่ราคา 0 และไม่เปิดช่องทางขาย",
      "สินค้าชั่งขายต้องตั้งหน่วยฐานเป็น GRAM, รหัสเครื่องชั่ง 5 หลัก และไซซ์ stock ให้ตรง ก่อนใช้ฉลากเครื่องชั่ง prefix 22",
    ],
  },
  {
    title: "POS / Loyalty",
    ...
    bullets: [
      ...
      "ฉลากเครื่องชั่ง prefix 22 ส่งน้ำหนักกรัมเข้าตะกร้าและ server ตรวจซ้ำตอนชำระ; ฉลาก prefix 21 ที่ฝังราคาจะถูกปฏิเสธเพื่อไม่ให้ยอด stock คลาดเคลื่อน",
      "เมนูที่ตั้ง Recipe จะจองและตัดวัตถุดิบตามสูตรกับ Modifier ที่เลือก และสร้าง Kitchen ticket หลังขายสำเร็จ; แก้สูตรภายหลังไม่เปลี่ยนบิลเก่า",
...
const SIDEBAR_MAP_GROUPS_TH: SidebarMapGroup[] = [
  {
    title: "แถวบนสุด (อยู่เหนือทุกหมวด)",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "ภาพรวมกะ POS", href: ROUTES.posShifts, note: "กะที่เปิด/ปิด ยอดขายต่อกะ เงินในลิ้นชัก และส่วนต่างตอนนับ" },
      { label: "กระดานครัว", href: ROUTES.kitchen, note: "ตั๋วครัวรวมตามโต๊ะ/รอบ/สถานี พร้อมเกณฑ์เวลาต่อสถานี" },
      { label: "จัดผังร้าน", href: ROUTES.restaurantFloor, note: "จัดโซน โต๊ะ รูปทรง และตำแหน่งบนผังแยกตามสาขา สำหรับร้านอาหาร" },
      { label: "แพลตฟอร์มเดลิเวอรี", href: ROUTES.deliveryPlatforms, note: "ตั้งค่า provider, mapping, ตรวจ incident/timeline และกระทบยอด settlement" },
      { label: "โต๊ะบอร์ดเกม", href: ROUTES.boardGame, note: "เปิดโต๊ะ จับเวลา แจ้งเตือน แยกกลุ่มบิล ยืมคืนเกม และส่งยอดไปเก็บเงินที่ POS" },
      { label: "คู่มือแคชเชียร์", href: ROUTES.posManual, note: "ขั้นตอนหน้าเคาน์เตอร์: เปิดกะ ขาย คืนของ พักบิล และปิดกะ" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "รูปแบบสต็อก", href: ROUTES.stockModels, note: "ตั้งว่าสินค้าถูกตัดออกจากชั้นแบบไหน (ตรง/สูตร/ชั่ง/ไม่คุมสต็อก) และความสามารถของร้าน" },
      ...
      { label: "ของเสีย", href: ROUTES.wastage, note: "ตัดของเสีย/หมดอายุออกจากสต็อกพร้อมเหตุผล และตัดล็อตที่หมดอายุก่อน" },
    ],
  },
  {
    title: "ลูกค้าและการตลาด",
    items: [
      ...
      { label: "โปรโมชัน", href: ROUTES.promotions, note: "ตั้งซื้อ X แถม Y / N ชิ้นราคาเดียว ทั้งร้านหรือเฉพาะสาขา — โปรของสาขาทับโปรทั้งร้าน" },
  ...
  {
    title: "งานเฉพาะร้าน (ตามประเภทร้าน)",
    items: [
  ...
  {
    title: "ตั้งค่าและดูแลร้าน",
    items: [
      { label: "เริ่มต้นใช้งาน", href: ROUTES.gettingStarted, note: "checklist ตั้งค่าร้านครั้งแรก จัดตามประเภทร้านที่เลือกไว้" },
      ...
      { label: "Support Diagnostics", href: ROUTES.supportDiagnostics, note: "Export หรือส่ง activity/error/audit ให้ทีม Support โดยต้องยืนยันก่อนส่ง" },
      ...
      { label: "คู่มือการใช้งาน", href: ROUTES.manual, note: "คู่มือฉบับนี้ ปักไว้ท้าย sidebar เสมอ" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "บทความ", href: ROUTES.posts, note: "เนื้อหาระดับแพลตฟอร์ม (เพิ่ม/แก้บทความอยู่ใต้เมนูนี้)" },
...
const LINK_STEPS_TH: LinkStep[] = [
  ...
  },
  {
    ...
    description: (
      <>
        เปิด {L.products} แล้วเลือก template เพิ่มข้อมูลหลักเป็น Draft ตั้ง Variant กับช่องทางขาย จากนั้นตั้ง Recipe/Pack ตาม Stock Policy และ Publish เมื่อ readiness ผ่าน · ถ้าจะปรับสต็อกให้กางแถวสินค้าเพื่อใช้ปุ่มลัดต่อ Variant หรือปรับหลายรายการ
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ใน {L.products} กด นำเข้า · ดาวน์โหลดเทมเพลตแล้วกรอก SKU / ชื่อสินค้า / ราคาขาย และคอลัมน์เสริม รูปแบบสินค้า / Stock Policy / ตัวเลือก / ช่องทางขาย · อัปโหลดแล้วระบบจะแสดงตัวอย่างว่าจะ สร้างใหม่ / อัปเดต / ข้าม ก่อนยืนยัน · รายการใหม่เป็น Draft, ไม่ต้องใส่รูปในไฟล์ และจำกัดสูงสุด 500 แถวต่อครั้ง
      </>
    ),
  },
  {
...
const TH: ManualContent = {
  ...
  posSubtitle: "ตั้งเครื่อง เปิดกะ ขายหน้าร้าน จัดการ DINE_IN/TAKEAWAY ที่ /pos/restaurant หรือส่งค่าเล่นบอร์ดเกมเข้า POS แล้วปิดกะตามลำดับงานจริง",
  ...
  posGuideCards: [
    ...
    {
      title: "ร้านอาหาร: เปิดโต๊ะหรือบิลกลับบ้านจนส่งมอบใบเสร็จ",
      desc: "รองรับทั้ง DINE_IN และ TAKEAWAY ใน /pos/restaurant เครื่องเดียว",
      steps: [
        "ที่แท็บ โต๊ะ เลือกโต๊ะเพื่อเปิดบิล DINE_IN หรือกด เปิดบิลกลับบ้าน เพื่อสร้าง TAKEAWAY; บิลกลับบ้านไม่ใช้โต๊ะและไม่สร้าง QR แต่จะแสดงในแถบบิลเปิด",
        "เลือกบิลที่เปิดอยู่ เพิ่มเมนูในแท็บ สั่ง แล้วกด ส่งครัว ทุกครั้งที่มีรอบใหม่; รายการที่ยังไม่ส่งจะคิดเงินไม่ได้ทั้งบิลโต๊ะและบิลกลับบ้าน",
        "เฉพาะ DINE_IN ที่ให้ลูกค้าสั่งเองได้: ผู้มี restaurant.floor.manage ออกและพิมพ์ QR จากหน้าจัดผังร้าน ลูกค้าสแกนได้เมื่อโต๊ะมีบิล OPEN แล้ว; รายการจะเข้าแท็บ QR เป็นคำขอรอรับและไม่เข้าครัวเอง",
        ...
        "ลูกค้ากดกระดิ่งเรียกพนักงานได้จากทุกแท็บของหน้า QR; ดู badge ที่แท็บ เรียก กด รับทราบ เมื่อกำลังไป และกด เสร็จแล้ว หลังดูแลโต๊ะเรียบร้อย",
        "ก่อนรับเงินค้นและเลือกสมาชิกในกล่องคิดเงินได้; ถ้า server ยืนยันว่าไม่พบ ให้กด สมัครสมาชิกใหม่ กรอกเบอร์และชื่อ ผู้ปฏิบัติงานต้องมี member.manage จากนั้นระบบจะเลือกสมาชิกที่สมัครเข้าบิลให้อัตโนมัติ",
        "ตอนชำระ ระบบเก็บ service mode ไว้กับออเดอร์เพื่อให้ใบเสร็จ ประวัติ และการพิมพ์ซ้ำแยก DINE_IN จาก TAKEAWAY ได้โดยไม่เดาจากโต๊ะภายหลัง",
      ...
      warning: "QR ใช้กับ DINE_IN เท่านั้นและเป็นรหัสประจำโต๊ะ ไม่ใช่รหัสบิล; TAKEAWAY ไม่มีโต๊ะ/QR และรุ่นนี้ย้ายโต๊ะ แยกบิล หรือรวมบิลไม่ได้ เงินออกต้องมี PIN ผู้อนุมัติคนที่สอง และการคืนอาหารหลังจ่ายยังใช้โหมดค้าปลีก",
    },
    {
      ...
      steps: [
        ...
        "เพิ่มชื่อเกมและกล่องเกมที่มีรหัส copy ในคลังเกมสำหรับเล่นที่ร้าน อย่าทำเป็น SKU สินค้า เพราะการยืมเล่นต้องเปลี่ยนสถานะกล่องโดยไม่ตัดสต็อกขาย",
        "แตะโต๊ะว่าง เลือกไม่กำหนดเวลา หรือกำหนดจำนวนนาที ตั้งเวลาแจ้งล่วงหน้า แล้วเพิ่มผู้ร่วมโต๊ะพร้อมเรตและหมายเลขกลุ่มบิล; เรต MEMBER ต้องเลือกสมาชิก CRM ที่มีอยู่จริง",
        "ระหว่างเล่นดูเวลาที่ผ่านไป สถานะใกล้ครบ/เกินเวลา และ popup แจ้งเตือน เพิ่มคนที่มาทีหลังหรือกดออกเพื่อหยุดเวลาของคนนั้น แล้วบันทึกเกมที่นำไปเล่นและรับคืนทุกกล่อง",
        "เมื่อจบให้กด หยุดเวลาและคิดราคา; server จะคำนวณจากเวลาเข้าออก ขั้นต่ำ การปัด และ grace ที่ snapshot ไว้ พร้อมรวมค่าเล่นตามกลุ่มบิลโดยไม่เชื่อราคาจากหน้าจอ",
        "กด ไปเก็บเงินที่ POS เพื่อสร้างบิลผ่าน order/payment เดิม กลุ่มค่าเล่นจะแยกเป็นบรรทัดในบิลเดียว สามารถเพิ่มสินค้าที่ขายจริงและใช้จ่ายผสมได้ แล้วจึงพิมพ์ใบเสร็จหรือทำ return/void ตามกฎ POS",
        "ถ้าต้องการให้ลูกค้าค้นหาร้านใกล้ฉัน ให้กรอกข้อมูลสาธารณะ พิกัด เวลาเปิด และตัวเลือกเผยแพร่เรต/จำนวนโต๊ะว่าง แล้วกดเผยแพร่; ก่อนเผยแพร่สาขาจะไม่ออกใน /board-game",
      ],
      warning: "รุ่นนี้ผูกสมาชิก CRM กับเรต MEMBER ได้ แต่ยังไม่มีสัญญาสมาชิกรายเดือน/รายปีหรือที่เก็บเลขบัตรประชาชนแบบเข้ารหัส ห้ามใส่เลขบัตรใน Note; กลุ่มบิลแยกค่าเวลาเป็นหลายบรรทัดในบิล POS เดียว ไม่ได้ออกหลายใบเสร็จอัตโนมัติ",
    },
    {
  ...
  posPermissions: [
    ...
    "ร้านอาหาร: ผู้มี restaurant.floor.manage จัดโซน โต๊ะ รูปทรง และตำแหน่งแยกตามสาขาที่ /admin/restaurant-floor; โต๊ะที่มีบิลเปิดลากตำแหน่งได้แต่แก้ข้อมูล ย้ายโซน ปิด หรือลบไม่ได้ ส่วน /pos/restaurant ใช้ pos.sell สำหรับเปิดโต๊ะ/สั่ง/ส่งครัว/ย้ายโต๊ะ/เก็บเงินและเริ่มยกเลิกทั้งบิล โดยการยกเลิกต้องลง Note เหตุผลทุกครั้ง และหลังส่งครัวต้องมีคนที่สองซึ่งมี pos.void อนุมัติ",
  ],
  ...
  posBoundaries: [
    ...
    "POS retail ยังเป็นค้าปลีกทั่วไป; ร้านอาหารแยกไปที่ /pos/restaurant พร้อมผังโต๊ะ บิลเปิด หลายรอบครัว ย้ายโต๊ะ และปิดบิลผ่าน settlement เดิม โดยไม่ปนตะกร้า retail; การยกเลิกหลังส่งครัวต้องมีผู้อนุมัติคนที่สองซึ่งมี pos.void",
  ],
...
const SIDEBAR_MAP_GROUPS_EN: SidebarMapGroup[] = [
  {
    title: "Top rows (above every group)",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "POS shift overview", href: ROUTES.posShifts, note: "Open and closed shifts, sales per shift, drawer cash and counting variance" },
      { label: "Kitchen Board", href: ROUTES.kitchen, note: "Kitchen tickets grouped by table, round and station with per-station timings" },
      { label: "Floor Plan", href: ROUTES.restaurantFloor, note: "Manage each restaurant branch's areas, tables, shapes and positions" },
      { label: "Delivery Platforms", href: ROUTES.deliveryPlatforms, note: "Configure providers and mappings, review incidents/timelines, and reconcile settlements" },
      { label: "Board Game Tables", href: ROUTES.boardGame, note: "Open tables, track time, manage alerts and game loans, then collect the server-calculated charge in POS" },
      { label: "Cashier Manual", href: ROUTES.posManual, note: "Counter procedures: open a shift, sell, return, park a bill and close out" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Stock Models", href: ROUTES.stockModels, note: "How each product leaves the shelf (direct, recipe, weighed, non-stock) plus shop capabilities" },
      ...
      { label: "Wastage", href: ROUTES.wastage, note: "Write off damaged or expired stock with a reason, consuming expired lots first" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Promotions", href: ROUTES.promotions, note: "Buy-X-get-Y and N-for-a-price deals, store-wide or per branch; a branch deal overrides the store-wide one" },
  ...
  {
    title: "Shop-specific work (by shop type)",
    items: [
  ...
  },
  {
    ...
    items: [
      { label: "Getting started", href: ROUTES.gettingStarted, note: "First-run setup checklist, ordered by the shop type you picked" },
      ...
      { label: "Support Diagnostics", href: ROUTES.supportDiagnostics, note: "Export or consent to send activity, error, and audit diagnostics to Support" },
      ...
      { label: "User manual", href: ROUTES.manual, note: "This manual, pinned at the bottom of the sidebar" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Posts", href: ROUTES.posts, note: "Platform-level content; create and edit live under this entry" },
...
const EN: ManualContent = {
  ...
  posSubtitle: "Set up a register, open a shift, sell at retail, run DINE_IN/TAKEAWAY in /pos/restaurant, or send board-game time charges to POS, then close the shift in operating order.",
  ...
  posGuideCards: [
    ...
    {
      title: "Restaurant: from table or take-away opening to receipt hand-off",
      desc: "One /pos/restaurant device handles both DINE_IN and TAKEAWAY.",
      steps: [
        "Under Tables, choose a table to open a DINE_IN check or press Open take-away check to create TAKEAWAY. A take-away check owns no table or QR and appears in the open-check rail.",
        "Select the open check, add dishes under Order, and send every new round to the kitchen. Checkout stays blocked while a line is unsent for either service mode.",
        "Self-ordering is DINE_IN only: a restaurant.floor.manage user issues and prints the table QR from Floor Plan. Guests can submit only while that table has an OPEN check; proposals wait under QR and never reach the kitchen automatically.",
        ...
        "Guests can use the floating bell from every QR-page tab. Watch the Calls badge, acknowledge when someone is heading over, and mark the request done after helping the table.",
        "Optionally find and select a member in checkout. If the server confirms no match, press Sign up a new member and enter the phone and name; the operator needs member.manage, and the new member is selected on the check automatically.",
        "Settlement snapshots the service mode onto the order so receipts, history, and reprints distinguish DINE_IN from TAKEAWAY without inferring it from mutable floor state.",
      ...
      warning: "Table QR is DINE_IN-only and identifies the table, not the bill. TAKEAWAY has no table/QR and currently cannot be moved, split, or merged. Cash out still needs a second approver PIN, and paid-food returns remain in retail mode.",
    },
    {
      ...
      steps: [
        ...
        "Create game titles and physical copies with copy codes in the play library. Do not model play copies as sellable SKUs: checking one out changes asset status without reducing retail stock.",
        "Tap an available table, choose open-ended or fixed duration, set the advance alert, and add participants with rates and billing-group numbers. A MEMBER rate must link to an existing CRM member.",
        "While guests play, watch elapsed time, ending-soon/overdue state, and alert popups. Add late arrivals or mark a participant as left to stop that person's time, and check every play copy out and back in.",
        "Press Stop time and calculate. The server prices the frozen participant snapshot from join/leave times, minimums, rounding, and grace, then totals the play charge by billing group.",
        "Press Go to POS to create the sale through the existing order/payment engine. Billing groups become separate time-charge lines on one receipt; sellable goods can be added and split tender remains available before printing or later return/void handling.",
        "For Nearby board game cafe search, enter the public address, coordinates, opening hours, and rate/availability disclosure choices, then publish. The branch remains absent from /board-game until explicitly published.",
      ],
      warning: "This release links CRM members to MEMBER rates but does not yet provide monthly/yearly subscription contracts or encrypted national-ID storage. Never put an ID number in Notes. Billing groups create separate time-charge lines in one POS order; they do not automatically issue separate receipts.",
    },
    {
  ...
  posPermissions: [
    ...
    "Restaurant: restaurant.floor.manage configures each branch's areas, tables, shapes and positions at /admin/restaurant-floor; an occupied table may be repositioned but cannot be edited, moved to another area, blocked or deleted. /pos/restaurant uses pos.sell to open, order, send, move, settle, and initiate whole-check cancellation; every cancellation requires a note, and a sent/reserved check still needs a distinct pos.void approver",
  ],
  ...
  posBoundaries: [
    ...
    "Retail POS stays general-retail. /pos/restaurant owns floor tables, open checks, kitchen rounds, table moves, and checkout while reusing the normal POS settlement engine; cancelling after a kitchen send requires a second, distinct approver with pos.void.",
  ],
