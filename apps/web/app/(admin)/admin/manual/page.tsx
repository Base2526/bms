...
> = {
  ...
  orders: {
    ...
    checks: [
      ...
      "กด สินค้า ที่แถบพิมพ์ แล้วเลือก แทรกข้อความ หรือ ข้อความ + รูป — ระบบจะใส่ไว้ในข้อความร่างก่อน ยังไม่ส่งทันที",
...
const helpRows = [
  ...
  {
    title: "แชร์สินค้าในแชทแล้วทำไมยังไม่ส่งทันที หรือไม่มีลิงก์สินค้า",
    answer: "ระบบตั้งใจใส่ข้อมูลสินค้าไว้ในข้อความร่างก่อน เพื่อให้ตรวจชื่อ ราคา ไซซ์ สต็อก และรูป แล้วค่อยกด ส่ง · เลือกได้ทั้ง แทรกข้อความ และ ข้อความ + รูป · ปัจจุบันยังไม่มีหน้าสินค้า public สำหรับลูกค้า จึงไม่ส่งลิงก์ /admin/products ออกไป; ปุ่มเปิด Products เป็นแท็บใหม่สำหรับพนักงานเท่านั้น",
  },
  {
