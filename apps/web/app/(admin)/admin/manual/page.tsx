...
const TH: ManualContent = {
  ...
  posBoundaries: [
    ...
    "POS retail ยังเป็นค้าปลีกทั่วไป; ร้านอาหารแยกไปที่ /pos/restaurant พร้อมผังโต๊ะ บิลเปิด หลายรอบครัว ย้ายโต๊ะ และปิดบิลผ่าน settlement เดิม โดยไม่ปนตะกร้า retail",
  ],
...
const EN: ManualContent = {
  ...
  posBoundaries: [
    ...
    "Retail POS stays general-retail. /pos/restaurant owns floor tables, open checks, kitchen rounds, table moves, and checkout while reusing the normal POS settlement engine.",
  ],
