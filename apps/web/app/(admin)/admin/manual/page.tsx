...
const MENU_CARDS_TH: MenuCard[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "แท็บมัดจำใช้รับเงินครั้งแรก/รับเพิ่ม/รับยอดคงเหลือ/ปิดมัดจำของสาขานี้; รับครบต้องใช้ปุ่มรับยอดคงเหลือเพื่อส่งของ ตัด stock และออกเอกสารในขั้นเดียว",
...
const MENU_CARDS_EN: MenuCard[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Use the Deposits tab to take, add, settle, or close layaway for this branch; a full balance must use Settle so stock and documents complete atomically",
