...
const helpRows = [
  ...
  },
  {
    ...
    answer: "ระบบใส่ชื่อ ราคา ไซซ์ สต็อก และ public link ไว้ในข้อความร่างก่อน เพื่อให้ตรวจแล้วค่อยกด ส่ง · เลือกได้ทั้ง ข้อความ + ลิงก์ และ ข้อความ + รูป + ลิงก์ · ในแชทส่งเฉพาะรูป cover 1 รูป ส่วนลูกค้ากด public link เพื่อดู gallery ทั้งหมดได้โดยไม่ต้อง login · ปุ่ม Products หลังบ้านเป็นแท็บใหม่สำหรับพนักงานและไม่ถูกส่งให้ลูกค้า",
  },
  {
