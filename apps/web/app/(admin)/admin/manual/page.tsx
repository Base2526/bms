...
const TH: ManualContent = {
  ...
  posSubtitle: "ตั้งเครื่อง เปิดกะ ขายหน้าร้าน หรือเข้า /pos/restaurant สำหรับร้านอาหาร แล้วปิดกะ ตามลำดับที่พนักงานใช้จริงบน /pos",
...
const EN: ManualContent = {
  ...
  posSubtitle: "Set up a register, open a shift, sell at retail or use /pos/restaurant for restaurants, take payment, process returns, receive goods, and close the shift in the same order staff use /pos.",
