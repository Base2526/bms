...
const ROADMAP_CONTENT: { en: RoadmapPageContent; th: RoadmapPageContent } = {
  en: {
    labels: {
      ...
      planned: "Planned",
      progressLabel: "Estimated delivery progress",
      ...
      notesText:
        "These are delivery phases rather than fixed calendar promises. Status reflects the repository as of September 14, 2026; production migration, external-provider, and hardware verification remain separate rollout gates.",
      tip1:
    ...
    capabilities: [
      ...
      {
        id: "vertical-operations",
        title: "Restaurant and board-game operations",
        status: "available",
        features: [
          "Restaurant floor, dine-in and takeaway checks, kitchen rounds, QR proposals, service calls, waitlist, and POS settlement",
          "Board-game zones and tables, open-ended or fixed-duration sessions, time alerts, participant rates, and split billing groups",
          "Playable game titles and physical copies with checkout, return, condition, and missing-parts workflows",
          "Board-game POS settlement and receipts plus opt-in nearby-cafe discovery with aggregate availability only",
        ],
      },
      {
      ...
      },
      {
        ...
        features: [
          ...
          "Desktop Emergency Offline Mode, signed/notarized installers, auto-update, audited manager reconciliation for terminal offline conflicts, and outage/soak evidence remain rollout work; there is no local-server or full-offline edition today",
    ...
    items: [
      ...
      {
        id: "q5",
        quarter: "Q5 - Board game cafe",
        title: "Timed table play and game-library operations",
        status: "done",
        tags: ["board-game", "pos", "membership", "discovery"],
        goals: [
          "Operate tables, time, participants, member rates, and playable game copies without mixing those concerns into product inventory",
          "Settle frozen time charges through the existing POS and publish nearby-cafe discovery only when each branch opts in",
        ],
        deliverables: [
          "Tenant/branch-scoped zones, tables, hourly rates, sessions, participant billing groups, alerts, overrides, and cancellation",
          "Game title/copy library with checkout, return, issue, condition, and availability states",
          "Atomic POS settlement with receipt/reprint service lines and retry-safe session linkage",
          "Bilingual admin operations, dev fixtures, and a rate-limited public nearby-cafe directory exposing only published aggregate data",
        ],
      },
      {
        id: "q6",
        quarter: "Q6 - POS mobile",
  ...
  th: {
    labels: {
      ...
      inProgress: "กำลังทำ",
      planned: "วางแผน",
      progressLabel: "ความคืบหน้าการส่งมอบโดยประมาณ",
      ...
      recommendTag: "สำคัญ",
      notesText:
        "รายการนี้เป็นลำดับการส่งมอบ ไม่ใช่คำสัญญาตามเดือนตายตัว สถานะอ้างอิง repository ณ วันที่ 14 กันยายน 2026 โดยการลง migration production, provider ภายนอก และ hardware verification ยังเป็น rollout gate แยกกัน",
      tip1:
    ...
    capabilities: [
      ...
      {
        id: "vertical-operations",
        title: "งานปฏิบัติการร้านอาหารและร้านบอร์ดเกม",
        status: "available",
        features: [
          "ผังร้านอาหาร บิลนั่งทาน/ซื้อกลับบ้าน รอบครัว QR proposal, เรียกพนักงาน คิวรอ และชำระผ่าน POS",
          "โซน/โต๊ะบอร์ดเกม session ไม่จำกัดเวลาหรือกำหนดเวลา แจ้งเตือน เรทผู้เล่น และกลุ่มแยกบิล",
          "คลังเกมที่แยกชื่อเกมและกล่องจริง พร้อมยืม คืน ตรวจสภาพ และสถานะชิ้นส่วนไม่ครบ",
          "ชำระค่าเวลาผ่าน POS/ใบเสร็จ และค้นหาร้านใกล้ฉันแบบ opt-in ที่เผยเฉพาะจำนวนว่างรวม",
        ],
      },
      {
        id: "reports-automation",
      ...
      },
      {
        ...
        features: [
          ...
          "Emergency Offline Mode บน Desktop, การ Sign/Notarize installer, Auto-update, การกระทบยอดโดยผู้จัดการแบบมี Audit สำหรับรายการออฟไลน์ที่แก้ต่อไม่ได้ และหลักฐาน Outage/Soak test ยังเป็นงาน Rollout; ปัจจุบันยังไม่มี Local Server หรือ Full Offline edition",
    ...
    items: [
      ...
      {
        id: "q5",
        quarter: "Q5 - ร้านบอร์ดเกมคาเฟ่",
        title: "จัดการเวลาโต๊ะและคลังเกมสำหรับเล่นในร้าน",
        status: "done",
        tags: ["board-game", "pos", "membership", "discovery"],
        goals: [
          "จัดการโต๊ะ เวลา ผู้เล่น เรทสมาชิก และกล่องเกม โดยไม่ปนกับ Product/Inventory ที่มีไว้ขาย",
          "ชำระค่าเวลาที่ freeze แล้วผ่าน POS เดิม และเผยร้านใกล้ฉันเมื่อแต่ละสาขากดยินยอมเท่านั้น",
        ],
        deliverables: [
          "โซน โต๊ะ เรทรายชั่วโมง session, billing group, alert, override และ cancel ที่ scope ตาม tenant/สาขา",
          "Game Library แยกชื่อเกม/กล่องจริง พร้อมยืม คืน พบปัญหา สภาพ และสถานะพร้อมเล่น",
          "POS settlement แบบ atomic พร้อม service line บนใบเสร็จ/พิมพ์ซ้ำ และ session linkage ที่ retry-safe",
          "หน้าปฏิบัติการสองภาษา fake fixture และหน้าค้นหาร้านใกล้ฉันที่ rate-limit และไม่เปิดเผยข้อมูลโต๊ะ/ลูกค้า",
        ],
      },
      {
        id: "q6",
        quarter: "Q6 - POS มือถือ",
...
export default function RoadmapPage() {
  ...
  const capabilityIconsById: Record<string, React.ReactNode> = {
    ...
    "vertical-operations": <ClockCircleOutlined />,
