...
export type MobilePosScanQuery = { bmsPosScan: { sku: string, size: string, productName: string, receiptName: string, baseQty: number, packCode: string, unitName: string, packPrice: number, basePrice: number, available: number, serialTracked: boolean, scaleBarcode: string | null, imageUrl: string | null, modifiers: Array<{ code: string, name: string, priceDelta: number, groupCode: string, groupName: string, selectionType: string, minSelect: number, maxSelect: number | null, defaultSelected: boolean }>, packs: Array<{ code: string, unitName: string, baseQty: number, price: number }> } };
