...
export type SchemaBmsPayment = {
  ...
  createdAt: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  memberPassId: Maybe<Scalars['ID']['output']>;
...
export type SchemaBmsPosBoardGameAddParticipantInput = {
  allowOverCapacity: InputMaybe<Scalars['Boolean']['input']>;
  ...
  pin: Scalars['String']['input'];
  purchasedDurationMinutes: InputMaybe<Scalars['Int']['input']>;
...
export type SchemaBmsPosBoardGameBillingGroupDetachResult = {
  __typename?: 'BmsPosBoardGameBillingGroupDetachResult';
  activeCount: Scalars['Int']['output'];
  billingGroupId: Scalars['ID']['output'];
  identityHoldIds: Array<Scalars['ID']['output']>;
  loanIds: Array<Scalars['ID']['output']>;
  replayed: Scalars['Boolean']['output'];
  seatingId: Scalars['ID']['output'];
  sessionId: Scalars['ID']['output'];
  sourceSessionId: Scalars['ID']['output'];
  tableId: Scalars['ID']['output'];
};

export type SchemaBmsPosBoardGameBillingGroupMergeResult = {
  __typename?: 'BmsPosBoardGameBillingGroupMergeResult';
  replayed: Scalars['Boolean']['output'];
  sessionId: Scalars['ID']['output'];
  sourceBillingGroupId: Scalars['ID']['output'];
  tabAmount: Scalars['Float']['output'];
  targetBillingGroupId: Scalars['ID']['output'];
};

export type SchemaBmsPosBoardGameChargeLine = {
  __typename?: 'BmsPosBoardGameChargeLine';
  actualEndedAt: Maybe<Scalars['String']['output']>;
  actualMinutes: Maybe<Scalars['Int']['output']>;
  amount: Scalars['Float']['output'];
  billableMinutes: Scalars['Int']['output'];
  billingGroupNo: Scalars['Int']['output'];
  chargedUntil: Maybe<Scalars['String']['output']>;
  coveredAmount: Maybe<Scalars['Float']['output']>;
  coveredMinutes: Maybe<Scalars['Int']['output']>;
...
export type SchemaBmsPosBoardGameCheckout = {
  ...
  chargeLines: Array<SchemaBmsPosBoardGameChargeLine>;
  ...
  offerDiscountAmount: Scalars['Float']['output'];
  ...
  tabItems: Array<SchemaBmsPosBoardGameCheckoutItem>;
  /** ส่วนลดราคาส่ง/โปรโมชันของสินค้า เทียบจากราคาบนบรรทัดกับยอดสินค้าในบิล */
  tabPricingDiscountAmount: Scalars['Float']['output'];
...
export type SchemaBmsPosBoardGameCheckoutItem = {
  __typename?: 'BmsPosBoardGameCheckoutItem';
  amount: Scalars['Float']['output'];
  id: Scalars['ID']['output'];
  packCode: Maybe<Scalars['String']['output']>;
  productName: Scalars['String']['output'];
...
export type SchemaBmsPosBoardGameDetachBillingGroupInput = {
  allowOverCapacity: InputMaybe<Scalars['Boolean']['input']>;
  billingGroupId: Scalars['ID']['input'];
  cashierUserId: Scalars['ID']['input'];
  idempotencyKey: Scalars['String']['input'];
  identityHoldIds: InputMaybe<Array<Scalars['ID']['input']>>;
  loanIds: InputMaybe<Array<Scalars['ID']['input']>>;
  pin: Scalars['String']['input'];
...
export type SchemaBmsPosBoardGameMergeBillingGroupsInput = {
  cashierUserId: Scalars['ID']['input'];
  idempotencyKey: Scalars['String']['input'];
  pin: Scalars['String']['input'];
  sourceBillingGroupId: Scalars['ID']['input'];
  targetBillingGroupId: Scalars['ID']['input'];
};
...
export type SchemaBmsPosBoardGameParticipant = {
  ...
  plannedEndAt: Maybe<Scalars['String']['output']>;
  rateCode: Maybe<Scalars['String']['output']>;
  rateName: Maybe<Scalars['String']['output']>;
  replayed: Maybe<Scalars['Boolean']['output']>;
  roundingMinutes: Maybe<Scalars['Int']['output']>;
  timeMode: Maybe<Scalars['String']['output']>;
};
...
export type SchemaBmsPosBoardGameReservationAddInput = {
  cashierUserId: Scalars['ID']['input'];
...
export type SchemaBmsPosBoardGameReservationReviewInput = {
  cashierUserId: Scalars['ID']['input'];
...
export type SchemaBmsPosBoardGameReservationUpdateInput = {
  cashierUserId: Scalars['ID']['input'];
  durationMinutes: Scalars['Int']['input'];
  entryId: Scalars['ID']['input'];
  guestName: InputMaybe<Scalars['String']['input']>;
...
export type SchemaBmsPosBoardGameSession = {
  ...
  nextAlertAt: Maybe<Scalars['String']['output']>;
...
export type SchemaBmsPosBoardGameWaitlist = {
  __typename?: 'BmsPosBoardGameWaitlist';
  calledCount: Scalars['Int']['output'];
  confirmedReservationCount: Scalars['Int']['output'];
  entries: Array<SchemaBmsPosBoardGameWaitlistEntry>;
  longestWaitMinutes: Scalars['Int']['output'];
  requestedReservationCount: Scalars['Int']['output'];
  tables: Array<SchemaBmsPosBoardGameWaitlistTable>;
  waitingCount: Scalars['Int']['output'];
  waitingGuests: Scalars['Int']['output'];
};

export type SchemaBmsPosBoardGameWaitlistAddInput = {
  cashierUserId: Scalars['ID']['input'];
  guestName: InputMaybe<Scalars['String']['input']>;
  guestPhone: InputMaybe<Scalars['String']['input']>;
  idempotencyKey: Scalars['String']['input'];
  ...
  partySize: Scalars['Int']['input'];
  pin: Scalars['String']['input'];
  preferredAreaId: InputMaybe<Scalars['ID']['input']>;
};

export type SchemaBmsPosBoardGameWaitlistCallInput = {
  cashierUserId: Scalars['ID']['input'];
  entryId: Scalars['ID']['input'];
  idempotencyKey: Scalars['String']['input'];
  pin: Scalars['String']['input'];
...
export type SchemaBmsPosBoardGameWaitlistCloseInput = {
  cashierUserId: Scalars['ID']['input'];
  entryId: Scalars['ID']['input'];
  idempotencyKey: Scalars['String']['input'];
  pin: Scalars['String']['input'];
...
export type SchemaBmsPosBoardGameWaitlistEntry = {
  __typename?: 'BmsPosBoardGameWaitlistEntry';
  calledAt: Maybe<Scalars['String']['output']>;
  checkedInAt: Maybe<Scalars['String']['output']>;
  closedAt: Maybe<Scalars['String']['output']>;
  confirmedAt: Maybe<Scalars['String']['output']>;
  createdAt: Scalars['String']['output'];
  decisionNotificationStatus: Scalars['String']['output'];
  depositAmount: Scalars['Float']['output'];
  depositDueAt: Maybe<Scalars['String']['output']>;
  depositPolicy: Scalars['String']['output'];
  depositRefundEligibleUntil: Maybe<Scalars['String']['output']>;
  depositStatus: Scalars['String']['output'];
  ...
  preferredAreaId: Maybe<Scalars['ID']['output']>;
  preferredAreaName: Maybe<Scalars['String']['output']>;
  queueNo: Maybe<Scalars['Int']['output']>;
  rejectionReason: Maybe<Scalars['String']['output']>;
  reminderSentAt: Maybe<Scalars['String']['output']>;
  reminderStatus: Scalars['String']['output'];
  reservedDurationMinutes: Maybe<Scalars['Int']['output']>;
  reservedFor: Maybe<Scalars['String']['output']>;
  reservedTableCode: Maybe<Scalars['String']['output']>;
  reservedTableId: Maybe<Scalars['ID']['output']>;
  reviewedAt: Maybe<Scalars['String']['output']>;
  seatedAt: Maybe<Scalars['String']['output']>;
  seatedSessionId: Maybe<Scalars['ID']['output']>;
...
export type SchemaBmsPosBoardGameWaitlistSeatInput = {
  alertBeforeMinutes: InputMaybe<Scalars['Int']['input']>;
  allowOverCapacity: InputMaybe<Scalars['Boolean']['input']>;
  billingMode: Scalars['String']['input'];
  cashierUserId: Scalars['ID']['input'];
...
export type SchemaBmsPosBoardGameWaitlistSeatResult = {
  __typename?: 'BmsPosBoardGameWaitlistSeatResult';
  entry: SchemaBmsPosBoardGameWaitlistEntry;
  session: SchemaBmsPosBoardGameSessionSummary;
};

export type SchemaBmsPosBoardGameWaitlistTable = {
  __typename?: 'BmsPosBoardGameWaitlistTable';
  areaId: Scalars['ID']['output'];
  availability: Scalars['String']['output'];
  code: Scalars['String']['output'];
  expectedAvailableAt: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  nextReservedAt: Maybe<Scalars['String']['output']>;
  nextReservedUntil: Maybe<Scalars['String']['output']>;
  seats: Scalars['Int']['output'];
};
...
export type SchemaBmsPosBoardGameWorkspace = {
  ...
  waitlist: SchemaBmsPosBoardGameWaitlist;
};
...
export type SchemaBmsPosDeviceDiagnosticEvent = {
  __typename?: 'BmsPosDeviceDiagnosticEvent';
  action: Scalars['String']['output'];
...
export type SchemaBmsPosMemberPreviewResult = {
  ...
  reservationDepositApplied: Maybe<Scalars['Float']['output']>;
  status: Maybe<Scalars['String']['output']>;
...
export type SchemaBmsPosPaymentQr = {
  __typename?: 'BmsPosPaymentQr';
  accountName: Maybe<Scalars['String']['output']>;
...
export type SchemaBmsPosReceipt = {
  ...
  offlineSyncedAt: Maybe<Scalars['String']['output']>;
  offlineTenderedAt: Maybe<Scalars['String']['output']>;
  orderId: Scalars['ID']['output'];
...
export type SchemaBmsPosSaleInput = {
  ...
  offlineTenderedAt: InputMaybe<Scalars['String']['input']>;
  payments: Array<SchemaBmsPosPaymentInput>;
...
export type SchemaBmsPosSaleRecoveryInput = {
  cashierUserId: Scalars['ID']['input'];
  idempotencyKey: Scalars['String']['input'];
  pin: Scalars['String']['input'];
};
...
export type SchemaBmsPosStoreReceiptSettings = {
  ...
  paymentQr: Maybe<SchemaBmsPosPaymentQr>;
  phone: Maybe<Scalars['String']['output']>;
...
export type SchemaMutation = {
  ...
  bmsPosAddBoardGameReservation: SchemaBmsPosBoardGameWaitlistEntry;
  bmsPosAddBoardGameTabItem: SchemaBmsPosBoardGameTabActionResult;
  bmsPosAddBoardGameWaitlistEntry: SchemaBmsPosBoardGameWaitlistEntry;
  ...
  bmsPosCallBoardGameWaitlistEntry: SchemaBmsPosBoardGameWaitlistEntry;
  ...
  bmsPosCheckInBoardGameReservation: SchemaBmsPosBoardGameWaitlistEntry;
  ...
  bmsPosCloseBoardGameWaitlistEntry: SchemaBmsPosBoardGameWaitlistEntry;
  ...
  bmsPosDetachBoardGameBillingGroup: SchemaBmsPosBoardGameBillingGroupDetachResult;
  ...
  bmsPosMergeBoardGameBillingGroups: SchemaBmsPosBoardGameBillingGroupMergeResult;
  ...
  bmsPosReviewBoardGameReservation: SchemaBmsPosBoardGameWaitlistEntry;
  bmsPosSale: SchemaBmsPosSaleResult;
  bmsPosSeatBoardGameWaitlistEntry: SchemaBmsPosBoardGameWaitlistSeatResult;
  ...
  bmsPosUpdateBoardGameReservation: SchemaBmsPosBoardGameWaitlistEntry;
...
export type SchemaMutationBmsPosAddBoardGameReservationArgs = {
  input: SchemaBmsPosBoardGameReservationAddInput;
};
...
export type SchemaMutationBmsPosAddBoardGameWaitlistEntryArgs = {
  input: SchemaBmsPosBoardGameWaitlistAddInput;
};
...
export type SchemaMutationBmsPosCallBoardGameWaitlistEntryArgs = {
  input: SchemaBmsPosBoardGameWaitlistCallInput;
};
...
export type SchemaMutationBmsPosCheckInBoardGameReservationArgs = {
  input: SchemaBmsPosBoardGameWaitlistCallInput;
};
...
export type SchemaMutationBmsPosCloseBoardGameWaitlistEntryArgs = {
  input: SchemaBmsPosBoardGameWaitlistCloseInput;
};
...
export type SchemaMutationBmsPosDetachBoardGameBillingGroupArgs = {
  input: SchemaBmsPosBoardGameDetachBillingGroupInput;
};
...
export type SchemaMutationBmsPosMergeBoardGameBillingGroupsArgs = {
  input: SchemaBmsPosBoardGameMergeBillingGroupsInput;
};
...
export type SchemaMutationBmsPosReviewBoardGameReservationArgs = {
  input: SchemaBmsPosBoardGameReservationReviewInput;
};
...
export type SchemaMutationBmsPosSeatBoardGameWaitlistEntryArgs = {
  input: SchemaBmsPosBoardGameWaitlistSeatInput;
};
...
export type SchemaMutationBmsPosUpdateBoardGameReservationArgs = {
  input: SchemaBmsPosBoardGameReservationUpdateInput;
};
...
export type SchemaQuery = {
  ...
  bmsPosDeviceDiagnostics: Array<SchemaBmsPosDeviceDiagnosticEvent>;
  ...
  bmsPosSaleRecovery: SchemaBmsPosSaleResult;
...
export type SchemaQueryBmsPosDeviceDiagnosticsArgs = {
...
export type SchemaQueryBmsPosSaleRecoveryArgs = {
  input: SchemaBmsPosSaleRecoveryInput;
};
...
export type BmsPosBoardGameAddParticipantInput = {
  allowOverCapacity: boolean | null | undefined;
  ...
  pin: string;
  purchasedDurationMinutes: number | null | undefined;
...
/** แยกกลุ่มบิลหนึ่งกลุ่มไปเปิดเป็น session ใหม่บนโต๊ะว่าง */
export type BmsPosBoardGameDetachBillingGroupInput = {
  allowOverCapacity: boolean | null | undefined;
  billingGroupId: string | number;
  cashierUserId: string | number;
  idempotencyKey: string;
  identityHoldIds: Array<string | number> | null | undefined;
  loanIds: Array<string | number> | null | undefined;
  pin: string;
...
/** รวมสองกลุ่มที่ยัง OPEN ใน session เดียวกันให้เก็บเงินเป็นบิลเดียว */
export type BmsPosBoardGameMergeBillingGroupsInput = {
  cashierUserId: string | number;
  idempotencyKey: string;
  pin: string;
  sourceBillingGroupId: string | number;
  targetBillingGroupId: string | number;
};
...
export type BmsPosBoardGameReservationAddInput = {
  cashierUserId: string | number;
...
export type BmsPosBoardGameReservationReviewInput = {
  cashierUserId: string | number;
  decision: string;
...
export type BmsPosBoardGameReservationUpdateInput = {
  cashierUserId: string | number;
  durationMinutes: number;
  entryId: string | number;
  guestName: string | null | undefined;
...
export type BmsPosBoardGameWaitlistAddInput = {
  cashierUserId: string | number;
  guestName: string | null | undefined;
  guestPhone: string | null | undefined;
  idempotencyKey: string;
  ...
  partySize: number;
  pin: string;
  preferredAreaId: string | number | null | undefined;
};

export type BmsPosBoardGameWaitlistCallInput = {
  cashierUserId: string | number;
  entryId: string | number;
  idempotencyKey: string;
  pin: string;
...
export type BmsPosBoardGameWaitlistCloseInput = {
  cashierUserId: string | number;
  entryId: string | number;
  idempotencyKey: string;
  pin: string;
...
export type BmsPosBoardGameWaitlistSeatInput = {
  alertBeforeMinutes: number | null | undefined;
  allowOverCapacity: boolean | null | undefined;
  billingMode: string;
  cashierUserId: string | number;
...
export type BmsPosSaleInput = {
  ...
  offlineTenderedAt: string | null | undefined;
  payments: Array<BmsPosPaymentInput>;
...
export type BmsPosSaleRecoveryInput = {
  cashierUserId: string | number;
  idempotencyKey: string;
  pin: string;
};
...
export type MobilePosSaleRecoveryQueryVariables = Exact<{
  input: BmsPosSaleRecoveryInput;
}>;


export type MobilePosSaleRecoveryQuery = { bmsPosSaleRecovery: { status: string, reason: string | null, orderId: string | null, receiptNo: string | null, billNo: string | null, total: number | null, cashTendered: number | null, cashChange: number | null, roundingAmount: number | null, replayed: boolean | null } };
...
export type MobilePosBoardGameSessionSummaryFieldsFragment = { id: string | null, sessionId: string | null, seatingId: string | null, sessionIds: Array<string> | null, sessionCount: number | null, status: string | null, billingMode: string | null, guestCount: number | null, startedAt: string | null, expectedEndAt: string | null, nextAlertAt: string | null, endedAt: string | null, alertBeforeMinutes: number | null, alertStatus: string | null, amountDue: number | null, billingGroupCount: number | null, awaitingPaymentCount: number | null, replayed: boolean | null };
...
export type MobilePosBoardGameWorkspaceQuery = { bmsPosBoardGameWorkspace: { floor: { areas: Array<{ id: string, name: string, sortOrder: number }>, tables: Array<{ id: string, areaId: string, code: string, name: string, seats: number, sortOrder: number, blocked: boolean, openSession: { id: string | null, sessionId: string | null, seatingId: string | null, sessionIds: Array<string> | null, sessionCount: number | null, status: string | null, billingMode: string | null, guestCount: number | null, startedAt: string | null, expectedEndAt: string | null, nextAlertAt: string | null, endedAt: string | null, alertBeforeMinutes: number | null, alertStatus: string | null, amountDue: number | null, billingGroupCount: number | null, awaitingPaymentCount: number | null, replayed: boolean | null } | null }> }, rates: Array<{ id: string, code: string, name: string, customerType: string, pricePerHour: number, minimumMinutes: number, roundingMinutes: number, graceMinutes: number, active: boolean, sortOrder: number }>, library: Array<{ id: string, title: string, minPlayers: number | null, maxPlayers: number | null, typicalMinutes: number | null, difficulty: string | null, language: string | null, publicVisible: boolean, copies: Array<{ id: string, locationId: string, copyCode: string, status: string, conditionNote: string | null }> }>, waitlist: { waitingCount: number, calledCount: number, confirmedReservationCount: number, requestedReservationCount: number, waitingGuests: number, longestWaitMinutes: number, entries: Array<{ id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string }>, tables: Array<{ id: string, areaId: string, code: string, name: string, seats: number, availability: string, expectedAvailableAt: string | null, nextReservedAt: string | null, nextReservedUntil: string | null }> } } };

export type MobilePosBoardGameWaitlistEntryFieldsFragment = { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string };

export type MobilePosAddBoardGameWaitlistEntryMutationVariables = Exact<{
  input: BmsPosBoardGameWaitlistAddInput;
}>;


export type MobilePosAddBoardGameWaitlistEntryMutation = { bmsPosAddBoardGameWaitlistEntry: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };

export type MobilePosCallBoardGameWaitlistEntryMutationVariables = Exact<{
  input: BmsPosBoardGameWaitlistCallInput;
}>;


export type MobilePosCallBoardGameWaitlistEntryMutation = { bmsPosCallBoardGameWaitlistEntry: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };

export type MobilePosCloseBoardGameWaitlistEntryMutationVariables = Exact<{
  input: BmsPosBoardGameWaitlistCloseInput;
}>;


export type MobilePosCloseBoardGameWaitlistEntryMutation = { bmsPosCloseBoardGameWaitlistEntry: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };

export type MobilePosSeatBoardGameWaitlistEntryMutationVariables = Exact<{
  input: BmsPosBoardGameWaitlistSeatInput;
}>;


export type MobilePosSeatBoardGameWaitlistEntryMutation = { bmsPosSeatBoardGameWaitlistEntry: { entry: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string }, session: { id: string | null, sessionId: string | null, seatingId: string | null, sessionIds: Array<string> | null, sessionCount: number | null, status: string | null, billingMode: string | null, guestCount: number | null, startedAt: string | null, expectedEndAt: string | null, nextAlertAt: string | null, endedAt: string | null, alertBeforeMinutes: number | null, alertStatus: string | null, amountDue: number | null, billingGroupCount: number | null, awaitingPaymentCount: number | null, replayed: boolean | null } } };

export type MobilePosAddBoardGameReservationMutationVariables = Exact<{
  input: BmsPosBoardGameReservationAddInput;
}>;


export type MobilePosAddBoardGameReservationMutation = { bmsPosAddBoardGameReservation: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };

export type MobilePosCheckInBoardGameReservationMutationVariables = Exact<{
  input: BmsPosBoardGameWaitlistCallInput;
}>;


export type MobilePosCheckInBoardGameReservationMutation = { bmsPosCheckInBoardGameReservation: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };

export type MobilePosUpdateBoardGameReservationMutationVariables = Exact<{
  input: BmsPosBoardGameReservationUpdateInput;
}>;


export type MobilePosUpdateBoardGameReservationMutation = { bmsPosUpdateBoardGameReservation: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };

export type MobilePosReviewBoardGameReservationMutationVariables = Exact<{
  input: BmsPosBoardGameReservationReviewInput;
}>;


export type MobilePosReviewBoardGameReservationMutation = { bmsPosReviewBoardGameReservation: { id: string, kind: string, serviceDate: string, queueNo: number | null, status: string, partySize: number, guestName: string | null, guestPhone: string | null, guestEmail: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, reservedFor: string | null, reservedDurationMinutes: number | null, reservedTableId: string | null, reservedTableCode: string | null, confirmedAt: string | null, checkedInAt: string | null, source: string, reviewedAt: string | null, rejectionReason: string | null, reminderStatus: string, reminderSentAt: string | null, decisionNotificationStatus: string, depositPolicy: string, depositAmount: number, depositStatus: string, depositDueAt: string | null, depositRefundEligibleUntil: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };
...
export type MobilePosOpenBoardGameSessionMutation = { bmsPosOpenBoardGameSession: { id: string | null, sessionId: string | null, seatingId: string | null, sessionIds: Array<string> | null, sessionCount: number | null, status: string | null, billingMode: string | null, guestCount: number | null, startedAt: string | null, expectedEndAt: string | null, nextAlertAt: string | null, endedAt: string | null, alertBeforeMinutes: number | null, alertStatus: string | null, amountDue: number | null, billingGroupCount: number | null, awaitingPaymentCount: number | null, replayed: boolean | null } };
...
export type MobilePosAddBoardGameParticipantMutation = { bmsPosAddBoardGameParticipant: { id: string, displayName: string | null, participantType: string | null, billable: boolean | null, hourlyRate: number | null, billingGroupNo: number | null, joinedAt: string | null, timeMode: string | null, plannedEndAt: string | null, replayed: boolean | null } };
...
export type MobilePosMergeBoardGameBillingGroupsMutationVariables = Exact<{
  input: BmsPosBoardGameMergeBillingGroupsInput;
}>;


export type MobilePosMergeBoardGameBillingGroupsMutation = { bmsPosMergeBoardGameBillingGroups: { sourceBillingGroupId: string, targetBillingGroupId: string, sessionId: string, tabAmount: number, replayed: boolean } };

export type MobilePosDetachBoardGameBillingGroupMutationVariables = Exact<{
  input: BmsPosBoardGameDetachBillingGroupInput;
}>;


export type MobilePosDetachBoardGameBillingGroupMutation = { bmsPosDetachBoardGameBillingGroup: { billingGroupId: string, sourceSessionId: string, sessionId: string, tableId: string, seatingId: string, activeCount: number, loanIds: Array<string>, identityHoldIds: Array<string>, replayed: boolean } };
...
export type MobilePosAdjustBoardGameTimingMutation = { bmsPosAdjustBoardGameTiming: { id: string | null, sessionId: string | null, seatingId: string | null, sessionIds: Array<string> | null, sessionCount: number | null, status: string | null, billingMode: string | null, guestCount: number | null, startedAt: string | null, expectedEndAt: string | null, nextAlertAt: string | null, endedAt: string | null, alertBeforeMinutes: number | null, alertStatus: string | null, amountDue: number | null, billingGroupCount: number | null, awaitingPaymentCount: number | null, replayed: boolean | null } };
...
export const MobilePosSaleRecoveryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MobilePosSaleRecovery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosSaleRecoveryInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosSaleRecovery"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"orderId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptNo"}},{"kind":"Field","name":{"kind":"Name","value":"billNo"}},{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"cashTendered"}},{"kind":"Field","name":{"kind":"Name","value":"cashChange"}},{"kind":"Field","name":{"kind":"Name","value":"roundingAmount"}},{"kind":"Field","name":{"kind":"Name","value":"replayed"}}]}}]}}]} as unknown as DocumentNode<MobilePosSaleRecoveryQuery, MobilePosSaleRecoveryQueryVariables>;
...
export const MobilePosBoardGameWorkspaceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MobilePosBoardGameWorkspace"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"credentials"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosCredentialsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosBoardGameWorkspace"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"credentials"},"value":{"kind":"Variable","name":{"kind":"Name","value":"credentials"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"floor"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"areas"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"sortOrder"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tables"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"areaId"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seats"}},{"kind":"Field","name":{"kind":"Name","value":"sortOrder"}},{"kind":"Field","name":{"kind":"Name","value":"blocked"}},{"kind":"Field","name":{"kind":"Name","value":"openSession"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameSessionSummaryFields"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"rates"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"customerType"}},{"kind":"Field","name":{"kind":"Name","value":"pricePerHour"}},{"kind":"Field","name":{"kind":"Name","value":"minimumMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"roundingMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"graceMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"sortOrder"}}]}},{"kind":"Field","name":{"kind":"Name","value":"library"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"minPlayers"}},{"kind":"Field","name":{"kind":"Name","value":"maxPlayers"}},{"kind":"Field","name":{"kind":"Name","value":"typicalMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"difficulty"}},{"kind":"Field","name":{"kind":"Name","value":"language"}},{"kind":"Field","name":{"kind":"Name","value":"publicVisible"}},{"kind":"Field","name":{"kind":"Name","value":"copies"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"locationId"}},{"kind":"Field","name":{"kind":"Name","value":"copyCode"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"conditionNote"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"waitlist"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"waitingCount"}},{"kind":"Field","name":{"kind":"Name","value":"calledCount"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedReservationCount"}},{"kind":"Field","name":{"kind":"Name","value":"requestedReservationCount"}},{"kind":"Field","name":{"kind":"Name","value":"waitingGuests"}},{"kind":"Field","name":{"kind":"Name","value":"longestWaitMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"entries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tables"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"areaId"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seats"}},{"kind":"Field","name":{"kind":"Name","value":"availability"}},{"kind":"Field","name":{"kind":"Name","value":"expectedAvailableAt"}},{"kind":"Field","name":{"kind":"Name","value":"nextReservedAt"}},{"kind":"Field","name":{"kind":"Name","value":"nextReservedUntil"}}]}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameSessionSummaryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameSessionSummary"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sessionId"}},{"kind":"Field","name":{"kind":"Name","value":"seatingId"}},{"kind":"Field","name":{"kind":"Name","value":"sessionIds"}},{"kind":"Field","name":{"kind":"Name","value":"sessionCount"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"billingMode"}},{"kind":"Field","name":{"kind":"Name","value":"guestCount"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"expectedEndAt"}},{"kind":"Field","name":{"kind":"Name","value":"nextAlertAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"alertBeforeMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"alertStatus"}},{"kind":"Field","name":{"kind":"Name","value":"amountDue"}},{"kind":"Field","name":{"kind":"Name","value":"billingGroupCount"}},{"kind":"Field","name":{"kind":"Name","value":"awaitingPaymentCount"}},{"kind":"Field","name":{"kind":"Name","value":"replayed"}}]}}]} as unknown as DocumentNode<MobilePosBoardGameWorkspaceQuery, MobilePosBoardGameWorkspaceQueryVariables>;
export const MobilePosAddBoardGameWaitlistEntryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosAddBoardGameWaitlistEntry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistAddInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosAddBoardGameWaitlistEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<MobilePosAddBoardGameWaitlistEntryMutation, MobilePosAddBoardGameWaitlistEntryMutationVariables>;
export const MobilePosCallBoardGameWaitlistEntryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosCallBoardGameWaitlistEntry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistCallInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosCallBoardGameWaitlistEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<MobilePosCallBoardGameWaitlistEntryMutation, MobilePosCallBoardGameWaitlistEntryMutationVariables>;
export const MobilePosCloseBoardGameWaitlistEntryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosCloseBoardGameWaitlistEntry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistCloseInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosCloseBoardGameWaitlistEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<MobilePosCloseBoardGameWaitlistEntryMutation, MobilePosCloseBoardGameWaitlistEntryMutationVariables>;
export const MobilePosSeatBoardGameWaitlistEntryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosSeatBoardGameWaitlistEntry"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistSeatInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosSeatBoardGameWaitlistEntry"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"entry"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"session"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameSessionSummaryFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameSessionSummaryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameSessionSummary"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sessionId"}},{"kind":"Field","name":{"kind":"Name","value":"seatingId"}},{"kind":"Field","name":{"kind":"Name","value":"sessionIds"}},{"kind":"Field","name":{"kind":"Name","value":"sessionCount"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"billingMode"}},{"kind":"Field","name":{"kind":"Name","value":"guestCount"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"expectedEndAt"}},{"kind":"Field","name":{"kind":"Name","value":"nextAlertAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"alertBeforeMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"alertStatus"}},{"kind":"Field","name":{"kind":"Name","value":"amountDue"}},{"kind":"Field","name":{"kind":"Name","value":"billingGroupCount"}},{"kind":"Field","name":{"kind":"Name","value":"awaitingPaymentCount"}},{"kind":"Field","name":{"kind":"Name","value":"replayed"}}]}}]} as unknown as DocumentNode<MobilePosSeatBoardGameWaitlistEntryMutation, MobilePosSeatBoardGameWaitlistEntryMutationVariables>;
export const MobilePosAddBoardGameReservationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosAddBoardGameReservation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameReservationAddInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosAddBoardGameReservation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<MobilePosAddBoardGameReservationMutation, MobilePosAddBoardGameReservationMutationVariables>;
export const MobilePosCheckInBoardGameReservationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosCheckInBoardGameReservation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistCallInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosCheckInBoardGameReservation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<MobilePosCheckInBoardGameReservationMutation, MobilePosCheckInBoardGameReservationMutationVariables>;
export const MobilePosUpdateBoardGameReservationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosUpdateBoardGameReservation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameReservationUpdateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosUpdateBoardGameReservation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<MobilePosUpdateBoardGameReservationMutation, MobilePosUpdateBoardGameReservationMutationVariables>;
export const MobilePosReviewBoardGameReservationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosReviewBoardGameReservation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameReservationReviewInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosReviewBoardGameReservation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"MobilePosBoardGameWaitlistEntryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameWaitlistEntry"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"serviceDate"}},{"kind":"Field","name":{"kind":"Name","value":"queueNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"partySize"}},{"kind":"Field","name":{"kind":"Name","value":"guestName"}},{"kind":"Field","name":{"kind":"Name","value":"guestPhone"}},{"kind":"Field","name":{"kind":"Name","value":"guestEmail"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaId"}},{"kind":"Field","name":{"kind":"Name","value":"preferredAreaName"}},{"kind":"Field","name":{"kind":"Name","value":"reservedFor"}},{"kind":"Field","name":{"kind":"Name","value":"reservedDurationMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"reservedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"confirmedAt"}},{"kind":"Field","name":{"kind":"Name","value":"checkedInAt"}},{"kind":"Field","name":{"kind":"Name","value":"source"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"rejectionReason"}},{"kind":"Field","name":{"kind":"Name","value":"reminderStatus"}},{"kind":"Field","name":{"kind":"Name","value":"reminderSentAt"}},{"kind":"Field","name":{"kind":"Name","value":"decisionNotificationStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositPolicy"}},{"kind":"Field","name":{"kind":"Name","value":"depositAmount"}},{"kind":"Field","name":{"kind":"Name","value":"depositStatus"}},{"kind":"Field","name":{"kind":"Name","value":"depositDueAt"}},{"kind":"Field","name":{"kind":"Name","value":"depositRefundEligibleUntil"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatedTableCode"}},{"kind":"Field","name":{"kind":"Name","value":"seatedSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"calledAt"}},{"kind":"Field","name":{"kind":"Name","value":"seatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<MobilePosReviewBoardGameReservationMutation, MobilePosReviewBoardGameReservationMutationVariables>;
export const MobilePosBoardGameSessionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MobilePosBoardGameSession"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"credentials"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosCredentialsInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosBoardGameSession"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"credentials"},"value":{"kind":"Variable","name":{"kind":"Name","value":"credentials"}}},{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"billingMode"}},{"kind":"Field","name":{"kind":"Name","value":"guestCount"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"expectedEndAt"}},{"kind":"Field","name":{"kind":"Name","value":"nextAlertAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"alertBeforeMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"alertStatus"}},{"kind":"Field","name":{"kind":"Name","value":"amountDue"}},{"kind":"Field","name":{"kind":"Name","value":"locationId"}},{"kind":"Field","name":{"kind":"Name","value":"tableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatingId"}},{"kind":"Field","name":{"kind":"Name","value":"billingGroups"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"groupNo"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"amountDue"}},{"kind":"Field","name":{"kind":"Name","value":"tabAmount"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"currentOrderId"}},{"kind":"Field","name":{"kind":"Name","value":"chargeSnapshot"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"participantId"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"participantType"}},{"kind":"Field","name":{"kind":"Name","value":"billingGroupNo"}},{"kind":"Field","name":{"kind":"Name","value":"billableMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"hourlyRate"}},{"kind":"Field","name":{"kind":"Name","value":"amount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tabItems"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sku"}},{"kind":"Field","name":{"kind":"Name","value":"productName"}},{"kind":"Field","name":{"kind":"Name","value":"size"}},{"kind":"Field","name":{"kind":"Name","value":"packCode"}},{"kind":"Field","name":{"kind":"Name","value":"unitName"}},{"kind":"Field","name":{"kind":"Name","value":"packQty"}},{"kind":"Field","name":{"kind":"Name","value":"modifierNames"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"addedAt"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"participants"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"participantType"}},{"kind":"Field","name":{"kind":"Name","value":"billable"}},{"kind":"Field","name":{"kind":"Name","value":"hourlyRate"}},{"kind":"Field","name":{"kind":"Name","value":"minimumMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"roundingMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"graceMinutes"}},{"kind":"Field","name":{"kind":"Name","value":"billingGroupNo"}},{"kind":"Field","name":{"kind":"Name","value":"billingGroupId"}},{"kind":"Field","name":{"kind":"Name","value":"billingGroupStatus"}},{"kind":"Field","name":{"kind":"Name","value":"joinedAt"}},{"kind":"Field","name":{"kind":"Name","value":"leftAt"}},{"kind":"Field","name":{"kind":"Name","value":"timeMode"}},{"kind":"Field","name":{"kind":"Name","value":"plannedEndAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"games"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"copyId"}},{"kind":"Field","name":{"kind":"Name","value":"copyCode"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"checkedOutAt"}},{"kind":"Field","name":{"kind":"Name","value":"returnedAt"}},{"kind":"Field","name":{"kind":"Name","value":"copyStatus"}}]}},{"kind":"Field","name":{"kind":"Name","value":"identityHolds"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"loanId"}},{"kind":"Field","name":{"kind":"Name","value":"documentKind"}},{"kind":"Field","name":{"kind":"Name","value":"holderName"}},{"kind":"Field","name":{"kind":"Name","value":"documentNumberTail"}},{"kind":"Field","name":{"kind":"Name","value":"hasDocumentNumber"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"note"}},{"kind":"Field","name":{"kind":"Name","value":"takenAt"}},{"kind":"Field","name":{"kind":"Name","value":"returnedAt"}}]}}]}}]}}]} as unknown as DocumentNode<MobilePosBoardGameSessionQuery, MobilePosBoardGameSessionQueryVariables>;
export const MobilePosBoardGameCheckoutDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MobilePosBoardGameCheckout"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"credentials"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosCredentialsInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosBoardGameCheckout"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"credentials"},"value":{"kind":"Variable","name":{"kind":"Name","value":"credentials"}}},{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sessionId"}},{"kind":"Field","name":{"kind":"Name","value":"groupNo"}},{"kind":"Field","name":{"kind":"Name","value":"sessionGroupCount"}},{"kind":"Field","name":{"kind":"Name","value":"tableCode"}},{"kind":"Field","name":{"kind":"Name","value":"tableName"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"amountDue"}},{"kind":"Field","name":{"kind":"Name","value":"tabAmount"}},{"kind":"Field","name":{"kind":"Name","value":"tabItemCount"}},{"kind":"Field","name":{"kind":"Name","value":"totalDue"}},{"kind":"Field","name":{"kind":"Name","value":"chargeLineCount"}},{"kind":"Field","name":{"kind":"Name","value":"passCoveredAmount"}},{"kind":"Field","name":{"kind":"Name","value":"offerCode"}},{"kind":"Field","name":{"kind":"Name","value":"offerName"}},{"kind":"Field","name":{"kind":"Name","value":"offerDiscountAmount"}}]}}]}}]} as unknown as DocumentNode<MobilePosBoardGameCheckoutQuery, MobilePosBoardGameCheckoutQueryVariables>;
...
export const MobilePosMergeBoardGameBillingGroupsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosMergeBoardGameBillingGroups"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameMergeBillingGroupsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosMergeBoardGameBillingGroups"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sourceBillingGroupId"}},{"kind":"Field","name":{"kind":"Name","value":"targetBillingGroupId"}},{"kind":"Field","name":{"kind":"Name","value":"sessionId"}},{"kind":"Field","name":{"kind":"Name","value":"tabAmount"}},{"kind":"Field","name":{"kind":"Name","value":"replayed"}}]}}]}}]} as unknown as DocumentNode<MobilePosMergeBoardGameBillingGroupsMutation, MobilePosMergeBoardGameBillingGroupsMutationVariables>;
export const MobilePosDetachBoardGameBillingGroupDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MobilePosDetachBoardGameBillingGroup"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BmsPosBoardGameDetachBillingGroupInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bmsPosDetachBoardGameBillingGroup"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"billingGroupId"}},{"kind":"Field","name":{"kind":"Name","value":"sourceSessionId"}},{"kind":"Field","name":{"kind":"Name","value":"sessionId"}},{"kind":"Field","name":{"kind":"Name","value":"tableId"}},{"kind":"Field","name":{"kind":"Name","value":"seatingId"}},{"kind":"Field","name":{"kind":"Name","value":"activeCount"}},{"kind":"Field","name":{"kind":"Name","value":"loanIds"}},{"kind":"Field","name":{"kind":"Name","value":"identityHoldIds"}},{"kind":"Field","name":{"kind":"Name","value":"replayed"}}]}}]}}]} as unknown as DocumentNode<MobilePosDetachBoardGameBillingGroupMutation, MobilePosDetachBoardGameBillingGroupMutationVariables>;
