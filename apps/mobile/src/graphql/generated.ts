...
export type MobilePosAddBoardGameWaitlistEntryMutation = { bmsPosAddBoardGameWaitlistEntry: { id: string, serviceDate: string, queueNo: number, status: string, partySize: number, guestName: string | null, guestPhone: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };
...
export type MobilePosCallBoardGameWaitlistEntryMutation = { bmsPosCallBoardGameWaitlistEntry: { id: string, serviceDate: string, queueNo: number, status: string, partySize: number, guestName: string | null, guestPhone: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };
...
export type MobilePosCloseBoardGameWaitlistEntryMutation = { bmsPosCloseBoardGameWaitlistEntry: { id: string, serviceDate: string, queueNo: number, status: string, partySize: number, guestName: string | null, guestPhone: string | null, note: string | null, preferredAreaId: string | null, preferredAreaName: string | null, seatedTableId: string | null, seatedTableCode: string | null, seatedSessionId: string | null, calledAt: string | null, seatedAt: string | null, closedAt: string | null, createdAt: string } };
