...
/**
 * ⚠️ ชิปตัวแรกของทุกแคตตาล็อกถูกใช้เป็น "แสดงทั้งหมด" (ดู MenuGrid) ชื่อจึงต้องพูดแบบนั้น
 * ของเดิมตั้งไว้ว่า 'ยอดนิยม' ทั้งที่ไม่มีเมนูไหนอยู่หมวดนั้นเลย — ชิปที่เขียนว่าเมนูยอดนิยม
 * แต่โชว์ทุกอย่างรวมของหวานและเครื่องดื่ม คือป้ายที่โกหก
 */
