...
ตอนนี้: **115 ไฟล์เทส** = pure 80 ไฟล์ (904 เทส) + DB 35 ไฟล์
...
> และ **34 จาก 35 ไฟล์ของชุด DB ไม่มีด่านของตัวเอง** (มีแค่ `restaurant-request-db-contract`
