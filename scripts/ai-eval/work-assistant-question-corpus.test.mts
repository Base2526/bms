...
test("the pinned corpus still covers the questions it was written for", () => {
  // 61 questions people actually ask (chips + hand-verified), plus coverage questions for the
  // rest of the catalog, plus 2 guards that must stay unanswerable.
  assert.equal(CORPUS_REAL_QUESTIONS.length, 61, "a pinned question disappeared or was added without review");
