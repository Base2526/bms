...
test("the pinned corpus still covers the questions it was written for", () => {
  // 72 questions people actually ask (chips + hand-verified), plus coverage questions for the
  // rest of the catalog, plus 2 guards that must stay unanswerable.
  // (+5 จาก `9.63`: แยกบิล/รวมบิล เป็นคำที่ลูกค้าพูดกับพนักงานที่โต๊ะจริง ๆ ทั้งไทยและอังกฤษ)
  assert.equal(CORPUS_REAL_QUESTIONS.length, 72, "a pinned question disappeared or was added without review");
