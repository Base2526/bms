...
export const WORK_ASSISTANT_QUESTION_CORPUS: readonly CorpusCase[] = [
  ...
  { q: "เปิดโต๊ะบอร์ดเกม", locale: "th", context: REGISTER, expect: "answer", expectTop: "pos.board-game-table" },
  { q: "open a board game table", locale: "en", context: REGISTER, expect: "answer", expectTop: "pos.board-game-table" },
  ...
  { q: "รับบัตรไว้", locale: "th", context: REGISTER, expect: "answer", expectTop: "pos.board-game-table" },
  { q: "ปิดบิลไม่ได้ ขึ้นว่าให้คืนบัตร", locale: "th", context: REGISTER, expect: "answer", expectTop: "pos.board-game-table" },
  { q: "รวมโต๊ะ", locale: "th", context: REGISTER, expect: "answer", expectTop: "pos.board-game-table" },
  { q: "ค่าเล่นเป็นศูนย์", locale: "th", context: REGISTER, expect: "answer", expectTop: "pos.board-game-table" },
  { q: "board game member pass", locale: "en", context: REGISTER, expect: "answer", expectTop: "pos.board-game-table" },
  ...
  // `9.93` บัตรที่รับไว้ค้ำกล่องเกม — คำถามที่ร้านถามจริงคือ "เก็บเลขบัตรได้ไหม" ไม่ใช่ชื่อฟีเจอร์
  { q: "ขอบัตรประชาชนลูกค้าไว้ตอนให้ยืมเกม", locale: "th", context: GUIDES, expect: "answer", expectTop: "board-game.run-cafe" },
  { q: "keep an ID card while a game is out", locale: "en", context: GUIDES, expect: "answer", expectTop: "board-game.run-cafe" },
  { q: "เก็บเลขบัตรลูกค้าได้ไหม", locale: "th", context: GUIDES, expect: "answer", expectTop: "board-game.run-cafe" },
  ...
  { q: "บันทึกภาษีซื้อและหัก ณ ที่จ่ายที่ไหน", locale: "th", context: GUIDES, expect: "answer", expectTop: "expense.record-document", origin: "coverage" },
  { q: "ระบบเก็บเอกสารรายจ่ายกับภาษีซื้อได้ไหม", locale: "th", context: CAPABILITIES, expect: "answer", expectTop: "expense.documents", expectStatus: "AVAILABLE", origin: "coverage" },
  ...
  { q: "เชื่อม foodpanda และจับคู่เมนูยังไง", locale: "th", context: GUIDES, expect: "answer", expectTop: "delivery-platforms.review", origin: "coverage" },
